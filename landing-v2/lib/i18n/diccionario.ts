...
export const DICCIONARIO: Record<string, Fila> = {
  ...
  /* ══════════════════════════════════════════════════════════════════
     CORPUS · CASOS HISTÓRICOS, G-PULSE Y LO QUE FALTABA

     LAS TRES DE MIGRACIÓN DE CONTRATO son las que explican el fallo que se
     arregló el 25-ago-2026: el corpus daba la dirección del PDF de 2024 como
     «la oficial». Estas respuestas son la razón de que existan dos direcciones
     válidas en la cadena, y por eso su precisión importa más que la media.

     LA MAYÚSCULA DE «EN LA MISMA WALLET DESDE LA QUE ENVIASTE» se conserva en
     los once idiomas. No es énfasis decorativo: quien envía desde una wallet a
     la que no tiene acceso pierde lo enviado, y es lo único que lo evita.

     «ENVIAR A UNA DIRECCIÓN VIEJA NO TIENE VUELTA ATRÁS» va tal cual, sin
     suavizar. Es la frase que evita el segundo envío.
     ══════════════════════════════════════════════════════════════════ */
  '¿Cómo funciona un cambio de contrato?': {
    en: 'How does a contract migration work?',
    pt: 'Como funciona uma troca de contrato?',
    fr: 'Comment fonctionne un changement de contrat ?',
    ru: 'Как работает смена контракта?',
    sv: 'Hur fungerar ett kontraktsbyte?',
    hr: 'Kako funkcionira promjena ugovora?',
    ar: 'كيف يعمل تغيير العقد؟',
    de: 'Wie funktioniert ein Vertragswechsel?',
    sr: 'Како функционише промена уговора?',
    ur: 'کنٹریکٹ کی تبدیلی کیسے ہوتی ہے؟',
  },
  'Cuando hay migración se anuncia por los canales oficiales, con los pasos y la dirección exacta a la que enviar. Envías tus monedas del contrato anterior y recibes las nuevas EN LA MISMA WALLET DESDE LA QUE ENVIASTE: no se entregan en otra dirección, así que la wallet que usas para enviar tiene que ser una a la que conserves el acceso.':
    {
      en: 'When there is a migration it is announced through the official channels, with the steps and the exact address to send to. You send your coins from the previous contract and receive the new ones IN THE SAME WALLET YOU SENT FROM: they are not delivered to another address, so the wallet you use to send must be one you still have access to.',
      pt: 'Quando há migração, ela é anunciada pelos canais oficiais, com os passos e o endereço exato para onde enviar. Você envia suas moedas do contrato anterior e recebe as novas NA MESMA CARTEIRA DE ONDE ENVIOU: não são entregues em outro endereço, então a carteira que você usa para enviar tem que ser uma à qual conserve o acesso.',
      fr: 'Lorsqu’il y a migration, elle est annoncée par les canaux officiels, avec les étapes et l’adresse exacte où envoyer. Tu envoies tes pièces de l’ancien contrat et tu reçois les nouvelles DANS LE MÊME PORTEFEUILLE D’OÙ TU AS ENVOYÉ : elles ne sont pas livrées à une autre adresse, donc le portefeuille utilisé pour envoyer doit être un auquel tu gardes l’accès.',
      ru: 'Когда происходит миграция, о ней объявляют по официальным каналам, с шагами и точным адресом для отправки. Ты отправляешь монеты старого контракта и получаешь новые В ТОТ ЖЕ КОШЕЛЁК, С КОТОРОГО ОТПРАВИЛ: их не выдают на другой адрес, поэтому кошелёк, с которого ты отправляешь, должен быть тем, к которому у тебя сохранён доступ.',
      sv: 'När en migrering sker annonseras den via de officiella kanalerna, med stegen och den exakta adressen att skicka till. Du skickar dina mynt från det tidigare kontraktet och får de nya TILL SAMMA PLÅNBOK SOM DU SKICKADE FRÅN: de levereras inte till någon annan adress, så plånboken du skickar från måste vara en du har kvar åtkomst till.',
      hr: 'Kad dođe do migracije, objavljuje se putem službenih kanala, s koracima i točnom adresom na koju treba poslati. Šalješ svoje novčiće s prethodnog ugovora i primaš nove U ISTI NOVČANIK IZ KOJEG SI POSLAO: ne isporučuju se na drugu adresu, pa novčanik kojim šalješ mora biti onaj kojem i dalje imaš pristup.',
      ar: 'عند حدوث ترحيل يُعلن عنه عبر القنوات الرسمية، مع الخطوات والعنوان الدقيق للإرسال. ترسل عملاتك من العقد السابق وتستلم الجديدة إلى المحفظة نفسها التي أرسلت منها: لا تُسلَّم إلى عنوان آخر، لذا يجب أن تكون المحفظة التي ترسل منها محفظةً ما زلت تملك الوصول إليها.',
      de: 'Wenn es eine Migration gibt, wird sie über die offiziellen Kanäle angekündigt — mit den Schritten und der genauen Adresse, an die zu senden ist. Du sendest deine Münzen vom vorherigen Vertrag und erhältst die neuen IN DERSELBEN WALLET, AUS DER DU GESENDET HAST: Sie werden nicht an eine andere Adresse geliefert, die Sende-Wallet muss also eine sein, zu der du weiterhin Zugang hast.',
      sr: 'Кад дође до миграције, објављује се путем званичних канала, са корацима и тачном адресом на коју треба послати. Шаљеш своје новчиће са претходног уговора и примаш нове У ИСТИ НОВЧАНИК ИЗ КОГ СИ ПОСЛАО: не испоручују се на другу адресу, па новчаник којим шаљеш мора бити онај коме и даље имаш приступ.',
      ur: 'جب مائیگریشن ہوتی ہے تو اس کا اعلان سرکاری چینلز پر ہوتا ہے، مراحل اور بھیجنے کے درست پتے کے ساتھ۔ آپ پرانے کنٹریکٹ کے سکے بھیجتے ہیں اور نئے اُسی والٹ میں وصول کرتے ہیں جس سے بھیجا تھا: وہ کسی اور پتے پر نہیں دیے جاتے، اس لیے جس والٹ سے بھیجیں وہ ایسا ہونا چاہیے جس تک آپ کی رسائی برقرار ہو۔',
    },
  '¿Todas las monedas entran en una migración?': {
    en: 'Do all coins qualify for a migration?',
    pt: 'Todas as moedas entram numa migração?',
    fr: 'Toutes les pièces entrent-elles dans une migration ?',
    ru: 'Все ли монеты попадают в миграцию?',
    sv: 'Ingår alla mynt i en migrering?',
    hr: 'Ulaze li svi novčići u migraciju?',
    ar: 'هل تدخل كل العملات في الترحيل؟',
    de: 'Kommen alle Münzen in eine Migration?',
    sr: 'Улазе ли сви новчићи у миграцију?',
    ur: 'کیا تمام سکے مائیگریشن میں شامل ہوتے ہیں؟',
  },
  'Entran las monedas legítimas, las que salieron de minar en el ecosistema. No entran las adquiridas en exchanges externos en vísperas de un cambio de contrato: la migración existe para acompañar a quien participa, no para que se acumule por fuera justo antes del canje.':
    {
      en: 'Legitimate coins qualify — the ones that came from mining within the ecosystem. Those acquired on external exchanges on the eve of a contract change do not: the migration exists to support those who take part, not so that people can stockpile from outside right before the swap.',
      pt: 'Entram as moedas legítimas, as que saíram de minerar no ecossistema. Não entram as adquiridas em exchanges externas às vésperas de uma troca de contrato: a migração existe para acompanhar quem participa, não para que se acumule por fora justo antes da troca.',
      fr: 'Les pièces légitimes entrent — celles issues du minage dans l’écosystème. Celles acquises sur des plateformes externes à la veille d’un changement de contrat, non : la migration existe pour accompagner ceux qui participent, pas pour qu’on accumule de l’extérieur juste avant l’échange.',
      ru: 'Попадают легитимные монеты — те, что получены майнингом внутри экосистемы. Не попадают купленные на внешних биржах накануне смены контракта: миграция существует, чтобы сопровождать тех, кто участвует, а не чтобы копить со стороны прямо перед обменом.',
      sv: 'Legitima mynt ingår — de som kommit från mining inom ekosystemet. De som köpts på externa börser strax före ett kontraktsbyte gör det inte: migreringen finns för att följa med dem som deltar, inte för att man ska samla på sig utifrån precis före bytet.',
      hr: 'Ulaze legitimni novčići, oni koji su nastali rudarenjem u ekosustavu. Ne ulaze oni nabavljeni na vanjskim burzama uoči promjene ugovora: migracija postoji da prati one koji sudjeluju, a ne da se gomila izvana neposredno prije zamjene.',
      ar: 'تدخل العملات المشروعة، تلك التي نتجت عن التعدين داخل النظام البيئي. ولا تدخل تلك المُشتراة من منصات خارجية عشية تغيير العقد: الترحيل موجود لمرافقة من يشارك، لا ليُكدَّس من الخارج قبيل التبديل.',
      de: 'Legitime Münzen kommen hinein — die, die aus dem Mining im Ökosystem stammen. Nicht die, die kurz vor einem Vertragswechsel auf externen Börsen gekauft wurden: Die Migration existiert, um Teilnehmende zu begleiten, nicht damit von außen kurz vor dem Tausch angehäuft wird.',
      sr: 'Улазе легитимни новчићи, они настали рударењем у екосистему. Не улазе они набављени на спољним берзама уочи промене уговора: миграција постоји да прати оне који учествују, а не да се гомила споља непосредно пре замене.',
      ur: 'جائز سکے شامل ہوتے ہیں، وہ جو ایکو سسٹم میں مائننگ سے بنے۔ کنٹریکٹ کی تبدیلی سے عین پہلے بیرونی ایکسچینجز سے خریدے گئے شامل نہیں ہوتے: مائیگریشن اُن کے ساتھ چلنے کے لیے ہے جو شریک ہیں، اس لیے نہیں کہ تبادلے سے ذرا پہلے باہر سے ذخیرہ کیا جائے۔',
    },
  'Envié al contrato antiguo y no recibí nada': {
    en: 'I sent to the old contract and received nothing',
    pt: 'Enviei ao contrato antigo e não recebi nada',
    fr: 'J’ai envoyé à l’ancien contrat et je n’ai rien reçu',
    ru: 'Я отправил на старый контракт и ничего не получил',
    sv: 'Jag skickade till det gamla kontraktet och fick inget',
    hr: 'Poslao sam na stari ugovor i nisam ništa primio',
    ar: 'أرسلت إلى العقد القديم ولم أستلم شيئًا',
    de: 'Ich habe an den alten Vertrag gesendet und nichts erhalten',
    sr: 'Послао сам на стари уговор и нисам ништа примио',
    ur: 'میں نے پرانے کنٹریکٹ پر بھیجا اور کچھ نہیں ملا',
  },
  'Es un caso para el equipo y no se resuelve siguiendo instrucciones sueltas: las direcciones cambiaron varias veces y enviar a una dirección vieja no tiene vuelta atrás. Escribe con tu usuario, tu correo, la wallet desde la que enviaste y el hash de la transacción — sin el hash no se puede reconstruir lo que pasó. Y no repitas el envío mientras esperas respuesta.':
    {
      en: 'This is a case for the team and it is not solved by following loose instructions: the addresses changed several times and sending to an old address cannot be undone. Write in with your username, your email, the wallet you sent from and the transaction hash — without the hash what happened cannot be reconstructed. And do not repeat the transfer while you wait for an answer.',
      pt: 'É um caso para a equipe e não se resolve seguindo instruções soltas: os endereços mudaram várias vezes e enviar a um endereço antigo não tem volta. Escreva com seu usuário, seu e-mail, a carteira de onde enviou e o hash da transação — sem o hash não se pode reconstruir o que aconteceu. E não repita o envio enquanto espera resposta.',
      fr: 'C’est un cas pour l’équipe et cela ne se règle pas en suivant des instructions éparses : les adresses ont changé plusieurs fois et envoyer à une vieille adresse est irréversible. Écris avec ton identifiant, ton e-mail, le portefeuille depuis lequel tu as envoyé et le hachage de la transaction — sans le hachage, impossible de reconstituer ce qui s’est passé. Et ne répète pas l’envoi en attendant la réponse.',
      ru: 'Это случай для команды, и он не решается по разрозненным инструкциям: адреса менялись несколько раз, и отправку на старый адрес не отменить. Напиши с логином, почтой, кошельком, с которого отправлял, и хешем транзакции — без хеша восстановить произошедшее нельзя. И не повторяй отправку, пока ждёшь ответа.',
      sv: 'Det här är ett ärende för teamet och löses inte genom att följa lösryckta instruktioner: adresserna ändrades flera gånger och att skicka till en gammal adress går inte att ångra. Skriv med ditt användarnamn, din e-post, plånboken du skickade från och transaktionshashen — utan hashen går det inte att rekonstruera vad som hände. Och upprepa inte överföringen medan du väntar på svar.',
      hr: 'Ovo je slučaj za tim i ne rješava se pojedinačnim uputama: adrese su se mijenjale više puta, a slanje na staru adresu nema povratka. Javi se sa svojim korisničkim imenom, e-poštom, novčanikom iz kojeg si poslao i hashom transakcije — bez hasha ne može se rekonstruirati što se dogodilo. I nemoj ponavljati slanje dok čekaš odgovor.',
      ar: 'هذه حالة للفريق ولا تُحلّ باتّباع تعليمات متفرقة: تغيّرت العناوين عدة مرات، والإرسال إلى عنوان قديم لا رجعة فيه. راسلنا باسم المستخدم وبريدك والمحفظة التي أرسلت منها و hash المعاملة — بدون الـ hash لا يمكن إعادة بناء ما حدث. ولا تُكرّر الإرسال بينما تنتظر الرد.',
      de: 'Das ist ein Fall fürs Team und lässt sich nicht mit losen Anleitungen lösen: Die Adressen haben sich mehrfach geändert, und ein Versand an eine alte Adresse ist nicht rückgängig zu machen. Schreib mit deinem Benutzernamen, deiner E-Mail, der Wallet, aus der du gesendet hast, und dem Transaktions-Hash — ohne den Hash lässt sich nicht rekonstruieren, was passiert ist. Und wiederhole den Versand nicht, während du auf Antwort wartest.',
      sr: 'Ово је случај за тим и не решава се појединачним упутствима: адресе су се мењале више пута, а слање на стару адресу нема повратка. Јави се са својим корисничким именом, е-поштом, новчаником из ког си послао и hash-ом трансакције — без hash-а не може се реконструисати шта се десило. И немој понављати слање док чекаш одговор.',
      ur: 'یہ ٹیم کا کیس ہے اور بکھری ہدایات پر عمل سے حل نہیں ہوتا: پتے کئی بار بدلے، اور پرانے پتے پر بھیجنے کی واپسی نہیں۔ اپنے صارف نام، ای میل، جس والٹ سے بھیجا اور ٹرانزیکشن کے hash کے ساتھ لکھیں — hash کے بغیر جو ہوا اُسے دوبارہ نہیں بنایا جا سکتا۔ اور جواب کا انتظار کرتے ہوئے دوبارہ نہ بھیجیں۔',
    },
  'La página no carga — ¿el sistema está en mantenimiento?': {
    en: 'The page does not load — is the system under maintenance?',
    pt: 'A página não carrega — o sistema está em manutenção?',
    fr: 'La page ne charge pas — le système est-il en maintenance ?',
    ru: 'Страница не загружается — система на обслуживании?',
    sv: 'Sidan laddar inte — är systemet under underhåll?',
    hr: 'Stranica se ne učitava — je li sustav u održavanju?',
    ar: 'الصفحة لا تُحمّل — هل النظام تحت الصيانة؟',
    de: 'Die Seite lädt nicht — ist das System in Wartung?',
    sr: 'Страница се не учитава — да ли је систем у одржавању?',
    ur: 'صفحہ نہیں کھلتا — کیا نظام مرمت میں ہے؟',
  },
  'Primero descarta lo local: recarga con Ctrl+Mayús+R, prueba en una ventana de incógnito (eso descarta caché y cookies) y, si puedes, desde otra red o con datos móviles. Si desde varios lugares sigue sin cargar, probablemente sea del lado del sistema: los mantenimientos y las caídas se comunican por los canales oficiales, así que revisa ahí antes de rehacer operaciones. Y si estabas en medio de una operación de dinero, no la repitas — verifica primero en qué quedó.':
    {
      en: 'First rule out the local side: reload with Ctrl+Shift+R, try an incognito window (that rules out cache and cookies) and, if you can, from another network or on mobile data. If it still does not load from several places, it is probably on the system side: maintenance and outages are announced through the official channels, so check there before redoing operations. And if you were in the middle of a money operation, do not repeat it — first verify how it ended up.',
      pt: 'Primeiro descarte o local: recarregue com Ctrl+Shift+R, tente numa janela anônima (isso descarta cache e cookies) e, se puder, de outra rede ou com dados móveis. Se de vários lugares continuar sem carregar, provavelmente é do lado do sistema: as manutenções e quedas são comunicadas pelos canais oficiais, então verifique ali antes de refazer operações. E se você estava no meio de uma operação de dinheiro, não a repita — verifique primeiro em que ficou.',
      fr: 'D’abord, écarte le local : recharge avec Ctrl+Maj+R, essaie une fenêtre privée (cela écarte le cache et les cookies) et, si tu peux, depuis un autre réseau ou en données mobiles. Si depuis plusieurs endroits ça ne charge toujours pas, c’est probablement côté système : les maintenances et les pannes sont annoncées par les canaux officiels, vérifie donc là avant de refaire des opérations. Et si tu étais au milieu d’une opération d’argent, ne la répète pas — vérifie d’abord où elle en est restée.',
      ru: 'Сначала исключи местное: перезагрузи с Ctrl+Shift+R, попробуй окно инкогнито (это исключает кэш и cookies) и, если можешь, из другой сети или с мобильного интернета. Если из нескольких мест по-прежнему не грузится, скорее всего дело в системе: об обслуживании и сбоях сообщают по официальным каналам, так что загляни туда, прежде чем переделывать операции. И если ты был в середине денежной операции, не повторяй её — сначала проверь, чем она закончилась.',
      sv: 'Uteslut först det lokala: ladda om med Ctrl+Shift+R, testa ett inkognitofönster (det utesluter cache och kakor) och, om du kan, från ett annat nätverk eller på mobildata. Laddar den ändå inte från flera håll ligger det troligen på systemsidan: underhåll och avbrott meddelas via de officiella kanalerna, så kolla där innan du gör om operationer. Och var du mitt i en pengaoperation, upprepa den inte — kontrollera först hur den slutade.',
      hr: 'Prvo isključi lokalno: osvježi s Ctrl+Shift+R, probaj u anonimnom prozoru (time isključuješ predmemoriju i kolačiće) i, ako možeš, s druge mreže ili mobilnih podataka. Ako s više mjesta i dalje ne učitava, vjerojatno je na strani sustava: održavanja i padovi objavljuju se putem službenih kanala, pa provjeri ondje prije nego ponavljaš operacije. A ako si bio usred novčane operacije, nemoj je ponavljati — prvo provjeri kako je završila.',
      ar: 'أولًا استبعد الجانب المحلي: أعد التحميل بـ Ctrl+Shift+R، وجرّب نافذة تصفح خفي (يستبعد ذلك ذاكرة التخزين وملفات الارتباط)، وإن أمكن من شبكة أخرى أو ببيانات الهاتف. وإذا استمر عدم التحميل من أماكن عدة، فالأرجح أنه من جهة النظام: تُعلَن الصيانة والأعطال عبر القنوات الرسمية، فراجعها قبل إعادة أي عمليات. وإن كنت في منتصف عملية مالية، لا تُكرّرها — تحقّق أولًا مما آلت إليه.',
      de: 'Schließe zuerst das Lokale aus: lade mit Strg+Umschalt+R neu, probiere ein Inkognito-Fenster (das schließt Cache und Cookies aus) und, wenn möglich, ein anderes Netz oder mobile Daten. Lädt sie auch von mehreren Orten nicht, liegt es wahrscheinlich am System: Wartungen und Ausfälle werden über die offiziellen Kanäle mitgeteilt, sieh also dort nach, bevor du Vorgänge wiederholst. Und wenn du mitten in einem Geldvorgang warst, wiederhole ihn nicht — prüfe zuerst, wie er ausging.',
      sr: 'Прво искључи локално: освежи са Ctrl+Shift+R, пробај у анонимном прозору (тиме искључујеш кеш и колачиће) и, ако можеш, са друге мреже или мобилних података. Ако са више места и даље не учитава, вероватно је на страни система: одржавања и падови објављују се путем званичних канала, па провери тамо пре него што понављаш операције. А ако си био усред новчане операције, немој је понављати — прво провери како је завршила.',
      ur: 'پہلے مقامی وجہ خارج کریں: Ctrl+Shift+R سے دوبارہ لوڈ کریں، ایک نجی (incognito) ونڈو آزمائیں (اس سے کیش اور کوکیز خارج ہو جاتی ہیں) اور اگر ممکن ہو تو کسی اور نیٹ ورک یا موبائل ڈیٹا سے۔ اگر کئی جگہوں سے بھی نہ کھلے تو غالباً یہ نظام کی طرف سے ہے: مرمت اور بندش کا اعلان سرکاری چینلز پر ہوتا ہے، تو عمل دہرانے سے پہلے وہاں دیکھیں۔ اور اگر آپ کسی مالی عمل کے بیچ تھے تو اسے نہ دہرائیں — پہلے دیکھیں کہ وہ کہاں رکا۔',
    },
  '¿Qué es G-Pulse?': {
    en: 'What is G-Pulse?', pt: 'O que é o G-Pulse?', fr: 'Qu’est-ce que G-Pulse ?',
    ru: 'Что такое G-Pulse?', sv: 'Vad är G-Pulse?', hr: 'Što je G-Pulse?',
    ar: 'ما هو G-Pulse؟', de: 'Was ist G-Pulse?', sr: 'Шта је G-Pulse?', ur: 'G-Pulse کیا ہے؟',
  },
  'Es la herramienta de análisis del ecosistema: procesa datos de mercados globales de forma continua y publica señales automatizadas y alertas, para que veas lo que está ocurriendo sin tener que mirar veinte pantallas.':
    {
      en: 'It is the ecosystem’s analysis tool: it processes global market data continuously and publishes automated signals and alerts, so you can see what is happening without watching twenty screens.',
      pt: 'É a ferramenta de análise do ecossistema: processa dados de mercados globais de forma contínua e publica sinais automatizados e alertas, para que você veja o que está acontecendo sem ter que olhar vinte telas.',
      fr: 'C’est l’outil d’analyse de l’écosystème : il traite en continu les données des marchés mondiaux et publie des signaux automatisés et des alertes, pour que tu voies ce qui se passe sans avoir à surveiller vingt écrans.',
      ru: 'Это аналитический инструмент экосистемы: он непрерывно обрабатывает данные мировых рынков и публикует автоматические сигналы и оповещения, чтобы ты видел происходящее, не глядя в двадцать экранов.',
      sv: 'Det är ekosystemets analysverktyg: det bearbetar data från globala marknader löpande och publicerar automatiserade signaler och varningar, så att du ser vad som händer utan att behöva bevaka tjugo skärmar.',
      hr: 'To je analitički alat ekosustava: neprekidno obrađuje podatke globalnih tržišta i objavljuje automatizirane signale i upozorenja, kako bi vidio što se događa bez gledanja u dvadeset zaslona.',
      ar: 'هي أداة التحليل في النظام البيئي: تعالج بيانات الأسواق العالمية باستمرار وتنشر إشارات وتنبيهات آلية، لترى ما يحدث دون أن تراقب عشرين شاشة.',
      de: 'Es ist das Analysewerkzeug des Ökosystems: Es verarbeitet fortlaufend Daten globaler Märkte und veröffentlicht automatisierte Signale und Warnungen, damit du siehst, was passiert, ohne zwanzig Bildschirme im Blick haben zu müssen.',
      sr: 'То је аналитички алат екосистема: непрекидно обрађује податке глобалних тржишта и објављује аутоматизоване сигнале и упозорења, како би видео шта се дешава без гледања у двадесет екрана.',
      ur: 'یہ ایکو سسٹم کا تجزیاتی آلہ ہے: عالمی منڈیوں کے اعداد و شمار مسلسل پروسیس کرتا ہے اور خودکار سگنلز اور الرٹس شائع کرتا ہے، تاکہ آپ بیس اسکرینیں دیکھے بغیر جان سکیں کہ کیا ہو رہا ہے۔',
    },
  '¿En qué se diferencia de G-Oracle?': {
    en: 'How is it different from G-Oracle?', pt: 'Em que se diferencia do G-Oracle?',
    fr: 'En quoi se distingue-t-il de G-Oracle ?', ru: 'Чем он отличается от G-Oracle?',
    sv: 'Hur skiljer det sig från G-Oracle?', hr: 'Po čemu se razlikuje od G-Oraclea?',
    ar: 'بمَ يختلف عن G-Oracle؟', de: 'Worin unterscheidet es sich von G-Oracle?',
    sr: 'По чему се разликује од G-Oracle-а?', ur: 'یہ G-Oracle سے کیسے مختلف ہے؟',
  },
  'G-Pulse es el pulso y G-Oracle es el criterio. G-Pulse entrega señales y alertas: qué está pasando ahora. G-Oracle interpreta, conecta y gobierna el flujo de información entre productos del protocolo: qué significa y cómo se orquesta.':
    {
      en: 'G-Pulse is the pulse and G-Oracle is the judgement. G-Pulse delivers signals and alerts: what is happening now. G-Oracle interprets, connects and governs the flow of information between the protocol’s products: what it means and how it is orchestrated.',
      pt: 'O G-Pulse é o pulso e o G-Oracle é o critério. O G-Pulse entrega sinais e alertas: o que está acontecendo agora. O G-Oracle interpreta, conecta e governa o fluxo de informação entre produtos do protocolo: o que significa e como se orquestra.',
      fr: 'G-Pulse, c’est le pouls, et G-Oracle, c’est le jugement. G-Pulse livre des signaux et des alertes : ce qui se passe maintenant. G-Oracle interprète, relie et gouverne le flux d’information entre les produits du protocole : ce que cela signifie et comment cela s’orchestre.',
      ru: 'G-Pulse — это пульс, а G-Oracle — суждение. G-Pulse выдаёт сигналы и оповещения: что происходит сейчас. G-Oracle интерпретирует, связывает и управляет потоком информации между продуктами протокола: что это значит и как это оркеструется.',
      sv: 'G-Pulse är pulsen och G-Oracle är omdömet. G-Pulse levererar signaler och varningar: vad som händer nu. G-Oracle tolkar, kopplar samman och styr informationsflödet mellan protokollets produkter: vad det betyder och hur det orkestreras.',
      hr: 'G-Pulse je puls, a G-Oracle je prosudba. G-Pulse daje signale i upozorenja: što se događa sada. G-Oracle tumači, povezuje i upravlja tokom informacija među proizvodima protokola: što to znači i kako se usklađuje.',
      ar: 'G-Pulse هو النبض و G-Oracle هو الحُكم. يقدّم G-Pulse الإشارات والتنبيهات: ما يحدث الآن. أما G-Oracle فيفسّر ويربط ويحكم تدفّق المعلومات بين منتجات البروتوكول: ماذا يعني وكيف يُنسَّق.',
      de: 'G-Pulse ist der Puls und G-Oracle das Urteil. G-Pulse liefert Signale und Warnungen: was gerade passiert. G-Oracle deutet, verknüpft und steuert den Informationsfluss zwischen den Produkten des Protokolls: was es bedeutet und wie es orchestriert wird.',
      sr: 'G-Pulse је пулс, а G-Oracle је процена. G-Pulse даје сигнале и упозорења: шта се дешава сада. G-Oracle тумачи, повезује и управља током информација међу производима протокола: шта то значи и како се усклађује.',
      ur: 'G-Pulse نبض ہے اور G-Oracle فیصلہ۔ G-Pulse سگنلز اور الرٹس دیتا ہے: ابھی کیا ہو رہا ہے۔ G-Oracle، پروٹوکول کی مصنوعات کے درمیان معلومات کے بہاؤ کی تشریح، ربط اور نگرانی کرتا ہے: اس کا مطلب کیا ہے اور یہ کیسے ترتیب پاتا ہے۔',
    },
  '¿Cómo entro a G-Pulse?': {
    en: 'How do I get into G-Pulse?', pt: 'Como entro no G-Pulse?',
    fr: 'Comment j’accède à G-Pulse ?', ru: 'Как войти в G-Pulse?',
    sv: 'Hur kommer jag in i G-Pulse?', hr: 'Kako ulazim u G-Pulse?',
    ar: 'كيف أدخل إلى G-Pulse؟', de: 'Wie komme ich in G-Pulse hinein?',
    sr: 'Како улазим у G-Pulse?', ur: 'میں G-Pulse میں کیسے داخل ہوں؟',
  },
  'Con tu cuenta de Genesis, desde conect.aigenesis.io. No hay registro aparte: es el mismo acceso que para el resto del ecosistema.':
    {
      en: 'With your Genesis account, from conect.aigenesis.io. There is no separate sign-up: it is the same login as for the rest of the ecosystem.',
      pt: 'Com sua conta Genesis, a partir de conect.aigenesis.io. Não há cadastro à parte: é o mesmo acesso que para o resto do ecossistema.',
      fr: 'Avec ton compte Genesis, depuis conect.aigenesis.io. Il n’y a pas d’inscription séparée : c’est le même accès que pour le reste de l’écosystème.',
      ru: 'Со своим аккаунтом Genesis, через conect.aigenesis.io. Отдельной регистрации нет: это тот же вход, что и во всю остальную экосистему.',
      sv: 'Med ditt Genesis-konto, via conect.aigenesis.io. Det finns ingen separat registrering: det är samma inloggning som till resten av ekosystemet.',
      hr: 'Sa svojim Genesis računom, preko conect.aigenesis.io. Nema zasebne registracije: to je isti pristup kao i za ostatak ekosustava.',
      ar: 'بحساب Genesis الخاص بك، من conect.aigenesis.io. لا يوجد تسجيل منفصل: إنه نفس الدخول إلى بقية النظام البيئي.',
      de: 'Mit deinem Genesis-Konto, über conect.aigenesis.io. Es gibt keine separate Registrierung: Es ist derselbe Zugang wie für den Rest des Ökosystems.',
      sr: 'Са својим Genesis налогом, преко conect.aigenesis.io. Нема засебне регистрације: то је исти приступ као и за остатак екосистема.',
      ur: 'اپنے Genesis اکاؤنٹ سے، conect.aigenesis.io پر۔ الگ رجسٹریشن نہیں: یہ وہی رسائی ہے جو باقی ایکو سسٹم کے لیے ہے۔',
    },
  'Todavía no está documentado paso a paso. El panel está detrás del acceso y esta guía no describe pantallas que no se han recorrido — antes que darte una ruta inventada, se te pasa con alguien que lo tenga delante.':
    {
      en: 'It is not documented step by step yet. The dashboard is behind the login and this guide does not describe screens that have not been walked through — rather than give you an invented route, you are put in touch with someone who has it in front of them.',
      pt: 'Ainda não está documentado passo a passo. O painel está atrás do acesso e este guia não descreve telas que não foram percorridas — antes de lhe dar uma rota inventada, você é encaminhado a alguém que o tenha à frente.',
      fr: 'Ce n’est pas encore documenté étape par étape. Le tableau de bord est derrière la connexion et ce guide ne décrit pas des écrans qui n’ont pas été parcourus — plutôt que de te donner un chemin inventé, on te met en relation avec quelqu’un qui l’a sous les yeux.',
      ru: 'Пошагово это ещё не описано. Панель находится за входом, а это руководство не описывает экраны, по которым никто не прошёл — вместо выдуманного маршрута тебя соединят с тем, у кого он перед глазами.',
      sv: 'Det är ännu inte dokumenterat steg för steg. Panelen ligger bakom inloggningen och den här guiden beskriver inte skärmar som ingen har gått igenom — i stället för en påhittad väg kopplas du till någon som har den framför sig.',
      hr: 'Još nije dokumentirano korak po korak. Ploča je iza prijave, a ovaj vodič ne opisuje zaslone koje nitko nije prošao — umjesto izmišljene rute, spajaju te s nekim tko je ima pred sobom.',
      ar: 'لم يُوثَّق بعد خطوة بخطوة. اللوحة خلف تسجيل الدخول، وهذا الدليل لا يصف شاشات لم يجرِ المرور بها — وبدل أن نعطيك مسارًا مُختلَقًا، نوصلك بمن يملكه أمامه.',
      de: 'Es ist noch nicht Schritt für Schritt dokumentiert. Das Panel liegt hinter der Anmeldung, und dieser Leitfaden beschreibt keine Bildschirme, die niemand durchlaufen hat — statt dir einen erfundenen Weg zu geben, wirst du mit jemandem verbunden, der ihn vor sich hat.',
      sr: 'Још није документовано корак по корак. Табла је иза пријаве, а овај водич не описује екране које нико није прошао — уместо измишљене руте, спајају те са неким ко је има пред собом.',
      ur: 'ابھی مرحلہ وار دستاویز نہیں ہے۔ پینل لاگ اِن کے پیچھے ہے اور یہ رہنما اُن اسکرینوں کو بیان نہیں کرتا جن سے کوئی گزرا نہ ہو — بنایا ہوا راستہ دینے کے بجائے آپ کو اُس شخص سے ملایا جاتا ہے جس کے سامنے وہ موجود ہو۔',
    },

  /* ══════════════════════════════════════════════════════════════════
     CORPUS · RED, RANGOS, G-ORACLE Y LA VISIÓN (última tanda)

     LOS PASOS NUMERADOS CONSERVAN SU NUMERACIÓN en los once idiomas. Alguien
     que sigue un procedimiento con la pantalla delante cuenta los pasos: si en
     su idioma son cuatro y en la captura que le mandaron son cinco, se pierde.

     LA TABLA DE RANGOS lleva puntos y USDT que no se tocan, y nombres de nivel
     que no se traducen. «G1 Bronze» es una etiqueta que aparece en pantalla:
     traducirla la vuelve imposible de encontrar.

     Y EL ROADMAP SE MANTIENE COMO ROADMAP: la tarjeta Visa/Mastercard y la
     academia son PLANES anunciados, no productos disponibles. La respuesta lo
     dice y añade que las fechas sólo valen desde los canales oficiales. Una
     traducción que lo cuente en presente convierte un plan en una promesa.
     ══════════════════════════════════════════════════════════════════ */
  '¿Cómo funcionan el referido directo y el binario?': {
    en: 'How do the direct referral and the binary work?',
    pt: 'Como funcionam a indicação direta e o binário?',
    fr: 'Comment fonctionnent le parrainage direct et le binaire ?',
    ru: 'Как работают прямой реферал и бинар?',
    sv: 'Hur fungerar direkthänvisningen och binären?',
    hr: 'Kako funkcioniraju izravna preporuka i binarni sustav?',
    ar: 'كيف تعمل الإحالة المباشرة والنظام الثنائي؟',
    de: 'Wie funktionieren die Direktempfehlung und das Binär?',
    sr: 'Како функционишу директна препорука и бинарни систем?',
    ur: 'ڈائریکٹ ریفرل اور بائنری کیسے کام کرتے ہیں؟',
  },
  'Son dos aceleradores de tu minería. Referido directo (AiG Start): por cada compra de minería de un invitado tuyo, tu minería acelera un 11% al instante, y vuelve a acelerar cada vez que recompra. Binario (AiG Binary): consigues un invitado en tu lado izquierdo y otro en el derecho, y el sistema acelera un 11% calculado sobre el volumen del lado con menor actividad — por eso conviene equilibrar ambos lados. No hay límite geográfico: tu comunidad puede estar en cualquier país.':
    {
      en: 'They are two accelerators for your mining. Direct referral (AiG Start): for every mining purchase by someone you invited, your mining accelerates by 11% instantly, and accelerates again each time they repurchase. Binary (AiG Binary): you get one invitee on your left side and one on your right, and the system accelerates by 11% calculated on the volume of the less active side — which is why it is worth balancing both sides. There is no geographic limit: your community can be in any country.',
      pt: 'São dois aceleradores da sua mineração. Indicação direta (AiG Start): a cada compra de mineração de um convidado seu, sua mineração acelera 11% no ato, e volta a acelerar cada vez que ele recompra. Binário (AiG Binary): você consegue um convidado do lado esquerdo e outro do direito, e o sistema acelera 11% calculado sobre o volume do lado com menor atividade — por isso convém equilibrar os dois lados. Não há limite geográfico: sua comunidade pode estar em qualquer país.',
      fr: 'Ce sont deux accélérateurs de ton minage. Parrainage direct (AiG Start) : pour chaque achat de minage d’un invité à toi, ton minage accélère de 11 % immédiatement, et accélère de nouveau à chaque rachat. Binaire (AiG Binary) : tu obtiens un invité à gauche et un autre à droite, et le système accélère de 11 % calculé sur le volume du côté le moins actif — d’où l’intérêt d’équilibrer les deux côtés. Aucune limite géographique : ta communauté peut être dans n’importe quel pays.',
      ru: 'Это два ускорителя твоего майнинга. Прямой реферал (AiG Start): за каждую покупку майнинга приглашённым тобой человеком твой майнинг мгновенно ускоряется на 11 % и ускоряется снова при каждой его повторной покупке. Бинар (AiG Binary): ты получаешь одного приглашённого слева и одного справа, и система ускоряет на 11 %, считая по объёму менее активной стороны — поэтому стоит уравновешивать обе. Географических ограничений нет: твоё сообщество может быть в любой стране.',
      sv: 'Det är två acceleratorer för din mining. Direkthänvisning (AiG Start): för varje miningköp av någon du bjudit in accelererar din mining med 11 % direkt, och accelererar igen varje gång personen köper på nytt. Binär (AiG Binary): du får en inbjuden på vänster sida och en på höger, och systemet accelererar med 11 % räknat på volymen hos den mindre aktiva sidan — därför lönar det sig att balansera båda. Ingen geografisk gräns: din gemenskap kan finnas i vilket land som helst.',
      hr: 'To su dva ubrzivača tvog rudarenja. Izravna preporuka (AiG Start): za svaku kupnju rudarenja tvog pozvanog, tvoje rudarenje odmah ubrzava za 11 %, i ubrzava ponovno svaki put kad on ponovno kupi. Binarni (AiG Binary): dobiješ jednog pozvanog na lijevoj strani i jednog na desnoj, a sustav ubrzava za 11 % računato na promet slabije aktivne strane — zato se isplati uravnotežiti obje. Nema geografskog ograničenja: tvoja zajednica može biti u bilo kojoj zemlji.',
      ar: 'هما مسرّعان لتعدينك. الإحالة المباشرة (AiG Start): مع كل شراء تعدين من شخص دعوته، يتسارع تعدينك بنسبة 11٪ فورًا، ويتسارع مجددًا كلما أعاد الشراء. الثنائي (AiG Binary): تحصل على مدعوّ في جهتك اليسرى وآخر في اليمنى، ويسرّع النظام بنسبة 11٪ محسوبة على حجم الجهة الأقل نشاطًا — لذلك يُستحسن موازنة الجهتين. لا يوجد حدّ جغرافي: يمكن أن يكون مجتمعك في أي بلد.',
      de: 'Das sind zwei Beschleuniger für dein Mining. Direktempfehlung (AiG Start): Bei jedem Mining-Kauf einer von dir eingeladenen Person beschleunigt dein Mining sofort um 11 % — und beschleunigt erneut, sooft sie nachkauft. Binär (AiG Binary): Du gewinnst eine eingeladene Person auf deiner linken und eine auf deiner rechten Seite, und das System beschleunigt um 11 %, berechnet auf das Volumen der weniger aktiven Seite — deshalb lohnt es sich, beide auszugleichen. Keine geografische Grenze: Deine Community kann in jedem Land sein.',
      sr: 'То су два убрзивача твог рударења. Директна препорука (AiG Start): за сваку куповину рударења твог позваног, твоје рударење одмах убрзава за 11 %, и убрзава поново сваки пут кад он поново купи. Бинарни (AiG Binary): добијеш једног позваног на левој страни и једног на десној, а систем убрзава за 11 % рачунато на промет слабије активне стране — зато се исплати уравнотежити обе. Нема географског ограничења: твоја заједница може бити у било којој земљи.',
      ur: 'یہ آپ کی مائننگ کے دو ایکسیلریٹر ہیں۔ ڈائریکٹ ریفرل (AiG Start): آپ کے مدعو کیے گئے شخص کی ہر مائننگ خریداری پر آپ کی مائننگ فوراً 11٪ تیز ہوتی ہے، اور ہر بار دوبارہ خریدنے پر پھر تیز ہوتی ہے۔ بائنری (AiG Binary): آپ کو بائیں طرف ایک اور دائیں طرف ایک مدعو ملتا ہے، اور نظام کم سرگرم طرف کے حجم پر 11٪ کے حساب سے تیز کرتا ہے — اسی لیے دونوں طرف توازن رکھنا بہتر ہے۔ کوئی جغرافیائی حد نہیں: آپ کی کمیونٹی کسی بھی ملک میں ہو سکتی ہے۔',
    },
  '¿Qué son los rangos (del Start al G11)?': {
    en: 'What are the ranks (from Start to G11)?',
    pt: 'O que são os ranks (do Start ao G11)?',
    fr: 'Que sont les rangs (du Start au G11) ?',
    ru: 'Что такое ранги (от Start до G11)?',
    sv: 'Vad är rangerna (från Start till G11)?',
    hr: 'Što su rangovi (od Starta do G11)?',
    ar: 'ما هي الرتب (من Start إلى G11)؟',
    de: 'Was sind die Ränge (von Start bis G11)?',
    sr: 'Шта су рангови (од Start-а до G11)?',
    ur: 'رینکس کیا ہیں (Start سے G11 تک)؟',
  },
  'Son niveles que alcanzas acumulando puntos en tu red, y cada uno da un premio en USDT más un NFT. Van desde G1 Bronze (1.000 puntos, 50 USDT) subiendo por Silver, Gold, Zappire, Ruby, Emerald, Diamond, Blue Diamond, Black Diamond, Red Diamond, hasta G11 (5.000.000 de puntos, 500.000 USDT). Los premios de rango se comunican y entregan por los canales oficiales del ecosistema.':
    {
      en: 'They are levels you reach by accumulating points in your network, and each one gives a USDT prize plus an NFT. They go from G1 Bronze (1,000 points, 50 USDT) up through Silver, Gold, Zappire, Ruby, Emerald, Diamond, Blue Diamond, Black Diamond, Red Diamond, to G11 (5,000,000 points, 500,000 USDT). Rank prizes are announced and delivered through the ecosystem’s official channels.',
      pt: 'São níveis que você alcança acumulando pontos na sua rede, e cada um dá um prêmio em USDT mais um NFT. Vão desde G1 Bronze (1.000 pontos, 50 USDT) subindo por Silver, Gold, Zappire, Ruby, Emerald, Diamond, Blue Diamond, Black Diamond, Red Diamond, até G11 (5.000.000 de pontos, 500.000 USDT). Os prêmios de rank são comunicados e entregues pelos canais oficiais do ecossistema.',
      fr: 'Ce sont des niveaux que tu atteins en accumulant des points dans ton réseau, et chacun donne une prime en USDT plus un NFT. Ils vont de G1 Bronze (1 000 points, 50 USDT) en montant par Silver, Gold, Zappire, Ruby, Emerald, Diamond, Blue Diamond, Black Diamond, Red Diamond, jusqu’à G11 (5 000 000 de points, 500 000 USDT). Les primes de rang sont annoncées et remises par les canaux officiels de l’écosystème.',
      ru: 'Это уровни, которых ты достигаешь, накапливая очки в своей сети, и каждый даёт приз в USDT плюс NFT. Идут от G1 Bronze (1 000 очков, 50 USDT) вверх через Silver, Gold, Zappire, Ruby, Emerald, Diamond, Blue Diamond, Black Diamond, Red Diamond, до G11 (5 000 000 очков, 500 000 USDT). Призы за ранг объявляются и выдаются по официальным каналам экосистемы.',
      sv: 'Det är nivåer du når genom att samla poäng i ditt nätverk, och var och en ger ett pris i USDT plus en NFT. De går från G1 Bronze (1 000 poäng, 50 USDT) upp via Silver, Gold, Zappire, Ruby, Emerald, Diamond, Blue Diamond, Black Diamond, Red Diamond, till G11 (5 000 000 poäng, 500 000 USDT). Rangpriser meddelas och delas ut via ekosystemets officiella kanaler.',
      hr: 'To su razine koje dosežeš skupljanjem bodova u svojoj mreži, a svaka daje nagradu u USDT-u plus NFT. Idu od G1 Bronze (1.000 bodova, 50 USDT) naviše preko Silver, Gold, Zappire, Ruby, Emerald, Diamond, Blue Diamond, Black Diamond, Red Diamond, do G11 (5.000.000 bodova, 500.000 USDT). Nagrade za rang objavljuju se i uručuju putem službenih kanala ekosustava.',
      ar: 'هي مستويات تبلغها بتجميع نقاط في شبكتك، وكل منها يمنح جائزة بالـ USDT إضافةً إلى NFT. تبدأ من G1 Bronze (1000 نقطة، 50 USDT) صعودًا عبر Silver و Gold و Zappire و Ruby و Emerald و Diamond و Blue Diamond و Black Diamond و Red Diamond، حتى G11 (5,000,000 نقطة، 500,000 USDT). تُعلن جوائز الرتب وتُسلَّم عبر القنوات الرسمية للنظام البيئي.',
      de: 'Das sind Stufen, die du durch das Sammeln von Punkten in deinem Netzwerk erreichst, und jede gibt einen USDT-Preis plus ein NFT. Sie reichen von G1 Bronze (1.000 Punkte, 50 USDT) aufwärts über Silver, Gold, Zappire, Ruby, Emerald, Diamond, Blue Diamond, Black Diamond, Red Diamond, bis G11 (5.000.000 Punkte, 500.000 USDT). Rangpreise werden über die offiziellen Kanäle des Ökosystems bekannt gegeben und übergeben.',
      sr: 'То су нивои које достижеш скупљањем поена у својој мрежи, а сваки даје награду у USDT-у плус NFT. Иду од G1 Bronze (1.000 поена, 50 USDT) навише преко Silver, Gold, Zappire, Ruby, Emerald, Diamond, Blue Diamond, Black Diamond, Red Diamond, до G11 (5.000.000 поена, 500.000 USDT). Награде за ранг објављују се и уручују путем званичних канала екосистема.',
      ur: 'یہ وہ درجے ہیں جو آپ اپنے نیٹ ورک میں پوائنٹس جمع کر کے حاصل کرتے ہیں، اور ہر ایک USDT میں انعام کے ساتھ ایک NFT دیتا ہے۔ یہ G1 Bronze (1,000 پوائنٹس، 50 USDT) سے شروع ہو کر Silver، Gold، Zappire، Ruby، Emerald، Diamond، Blue Diamond، Black Diamond، Red Diamond سے ہوتے ہوئے G11 (5,000,000 پوائنٹس، 500,000 USDT) تک جاتے ہیں۔ رینک کے انعامات ایکو سسٹم کے سرکاری چینلز پر بتائے اور دیے جاتے ہیں۔',
    },
  '¿Qué es G-Oracle?': {
    en: 'What is G-Oracle?', pt: 'O que é o G-Oracle?', fr: 'Qu’est-ce que G-Oracle ?',
    ru: 'Что такое G-Oracle?', sv: 'Vad är G-Oracle?', hr: 'Što je G-Oracle?',
    ar: 'ما هو G-Oracle؟', de: 'Was ist G-Oracle?', sr: 'Шта је G-Oracle?', ur: 'G-Oracle کیا ہے؟',
  },
  'G-Oracle es el espacio donde los usuarios consumen, ofrecen y generan ingresos dentro de la red: descubres negocios y servicios cerca de ti, accedes a comercios del ecosistema en segundos, y puedes ofrecer tus propios productos o servicios a la comunidad G11. Es la parte de comercios y servicios del ecosistema.':
    {
      en: 'G-Oracle is the space where users consume, offer and earn within the network: you discover businesses and services near you, reach ecosystem merchants in seconds, and can offer your own products or services to the G11 community. It is the merchants-and-services part of the ecosystem.',
      pt: 'O G-Oracle é o espaço onde os usuários consomem, oferecem e geram receita dentro da rede: você descobre negócios e serviços perto de você, acessa comércios do ecossistema em segundos, e pode oferecer seus próprios produtos ou serviços à comunidade G11. É a parte de comércios e serviços do ecossistema.',
      fr: 'G-Oracle est l’espace où les utilisateurs consomment, proposent et génèrent des revenus au sein du réseau : tu découvres des commerces et services près de chez toi, tu accèdes en quelques secondes aux commerces de l’écosystème, et tu peux proposer tes propres produits ou services à la communauté G11. C’est la partie commerces et services de l’écosystème.',
      ru: 'G-Oracle — это пространство, где пользователи потребляют, предлагают и зарабатывают внутри сети: ты находишь бизнесы и услуги рядом с собой, за секунды попадаешь к продавцам экосистемы и можешь предложить свои товары или услуги сообществу G11. Это торгово-сервисная часть экосистемы.',
      sv: 'G-Oracle är utrymmet där användarna konsumerar, erbjuder och tjänar inom nätverket: du upptäcker företag och tjänster nära dig, når ekosystemets handlare på sekunder och kan erbjuda dina egna produkter eller tjänster till G11-gemenskapen. Det är ekosystemets handels- och tjänstedel.',
      hr: 'G-Oracle je prostor u kojem korisnici troše, nude i zarađuju unutar mreže: otkrivaš tvrtke i usluge blizu sebe, u nekoliko sekundi dolaziš do trgovaca ekosustava i možeš ponuditi vlastite proizvode ili usluge zajednici G11. To je trgovački i uslužni dio ekosustava.',
      ar: 'G-Oracle هو الفضاء الذي يستهلك فيه المستخدمون ويعرضون ويحققون دخلًا داخل الشبكة: تكتشف أعمالًا وخدمات قريبة منك، وتصل إلى متاجر النظام البيئي في ثوانٍ، ويمكنك عرض منتجاتك أو خدماتك على مجتمع G11. هو الجزء التجاري والخدمي من النظام البيئي.',
      de: 'G-Oracle ist der Raum, in dem Nutzende innerhalb des Netzwerks konsumieren, anbieten und Einnahmen erzielen: Du entdeckst Betriebe und Dienstleistungen in deiner Nähe, erreichst Händler des Ökosystems in Sekunden und kannst der G11-Community eigene Produkte oder Dienste anbieten. Es ist der Handels- und Dienstleistungsteil des Ökosystems.',
      sr: 'G-Oracle је простор у ком корисници троше, нуде и зарађују унутар мреже: откриваш фирме и услуге близу себе, за неколико секунди долазиш до трговаца екосистема и можеш понудити сопствене производе или услуге заједници G11. То је трговински и услужни део екосистема.',
      ur: 'G-Oracle وہ جگہ ہے جہاں صارفین نیٹ ورک کے اندر خریدتے، پیش کرتے اور کماتے ہیں: آپ اپنے قریب کے کاروبار اور خدمات دریافت کرتے ہیں، سیکنڈوں میں ایکو سسٹم کے تاجروں تک پہنچتے ہیں، اور G11 کمیونٹی کو اپنی مصنوعات یا خدمات پیش کر سکتے ہیں۔ یہ ایکو سسٹم کا تجارت اور خدمات والا حصہ ہے۔',
    },
  '¿Va a haber tarjeta Visa/Mastercard o academia?': {
    en: 'Will there be a Visa/Mastercard card or an academy?',
    pt: 'Vai haver cartão Visa/Mastercard ou academia?',
    fr: 'Y aura-t-il une carte Visa/Mastercard ou une académie ?',
    ru: 'Будет ли карта Visa/Mastercard или академия?',
    sv: 'Kommer det ett Visa/Mastercard-kort eller en akademi?',
    hr: 'Hoće li biti Visa/Mastercard kartice ili akademije?',
    ar: 'هل ستكون هناك بطاقة Visa/Mastercard أو أكاديمية؟',
    de: 'Wird es eine Visa-/Mastercard-Karte oder eine Akademie geben?',
    sr: 'Хоће ли бити Visa/Mastercard картице или академије?',
    ur: 'کیا Visa/Mastercard کارڈ یا اکیڈمی آئے گی؟',
  },
  'El material oficial menciona en su roadmap tecnológico la integración con sistemas de pago Visa / Mastercard para uso cotidiano del AiG Token, y una plataforma educativa (academia) con servicios impulsados por IA, junto a la consolidación de la comunidad en tres continentes. Son planes del roadmap: las fechas y la disponibilidad se anuncian únicamente por los canales oficiales — trata con cautela cualquier fecha que veas por fuera.':
    {
      en: 'The official material mentions, in its technology roadmap, integration with Visa / Mastercard payment systems for everyday use of the AiG Token, and an educational platform (academy) with AI-driven services, along with consolidating the community across three continents. These are roadmap plans: dates and availability are announced only through the official channels — treat any date you see elsewhere with caution.',
      pt: 'O material oficial menciona no seu roadmap tecnológico a integração com sistemas de pagamento Visa / Mastercard para uso cotidiano do AiG Token, e uma plataforma educacional (academia) com serviços impulsionados por IA, junto à consolidação da comunidade em três continentes. São planos do roadmap: as datas e a disponibilidade são anunciadas unicamente pelos canais oficiais — trate com cautela qualquer data que veja por fora.',
      fr: 'Le matériel officiel mentionne dans sa feuille de route technologique l’intégration aux systèmes de paiement Visa / Mastercard pour un usage quotidien du AiG Token, et une plateforme éducative (académie) avec des services propulsés par l’IA, ainsi que la consolidation de la communauté sur trois continents. Ce sont des plans de la feuille de route : les dates et la disponibilité sont annoncées uniquement par les canaux officiels — traite avec prudence toute date vue ailleurs.',
      ru: 'В официальных материалах в технологической дорожной карте упоминается интеграция с платёжными системами Visa / Mastercard для повседневного использования AiG Token и образовательная платформа (академия) с сервисами на базе ИИ, а также укрепление сообщества на трёх континентах. Это планы дорожной карты: даты и доступность объявляются только по официальным каналам — к любой дате, увиденной в другом месте, относись осторожно.',
      sv: 'Det officiella materialet nämner i sin teknikfärdplan integration med betalsystemen Visa / Mastercard för vardagsanvändning av AiG Token, och en utbildningsplattform (akademi) med AI-drivna tjänster, jämte att befästa gemenskapen på tre kontinenter. Det är planer i färdplanen: datum och tillgänglighet meddelas endast via de officiella kanalerna — behandla varje datum du ser på annat håll med försiktighet.',
      hr: 'Službeni materijal u svojoj tehnološkoj mapi puta spominje integraciju s platnim sustavima Visa / Mastercard za svakodnevnu upotrebu AiG Tokena, te obrazovnu platformu (akademiju) s uslugama koje pokreće umjetna inteligencija, uz učvršćivanje zajednice na tri kontinenta. To su planovi iz mape puta: datumi i dostupnost objavljuju se isključivo putem službenih kanala — svaki datum koji vidiš drugdje uzmi s oprezom.',
      ar: 'تذكر المواد الرسمية في خارطة الطريق التقنية التكامل مع أنظمة الدفع Visa / Mastercard للاستخدام اليومي لـ AiG Token، ومنصّة تعليمية (أكاديمية) بخدمات مدفوعة بالذكاء الاصطناعي، إلى جانب ترسيخ المجتمع في ثلاث قارات. هذه خطط في خارطة الطريق: تُعلن المواعيد والتوفّر عبر القنوات الرسمية فقط — وتعامل بحذر مع أي تاريخ تراه في مكان آخر.',
      de: 'Das offizielle Material erwähnt in seiner Technologie-Roadmap die Integration mit den Zahlungssystemen Visa / Mastercard für den Alltagsgebrauch des AiG Token sowie eine Bildungsplattform (Akademie) mit KI-gestützten Diensten, dazu die Festigung der Community auf drei Kontinenten. Das sind Roadmap-Pläne: Termine und Verfügbarkeit werden ausschließlich über die offiziellen Kanäle bekannt gegeben — behandle jedes anderswo gesehene Datum mit Vorsicht.',
      sr: 'Званични материјал у својој технолошкој мапи пута помиње интеграцију са платним системима Visa / Mastercard за свакодневну употребу AiG Token-а, те образовну платформу (академију) са услугама које покреће вештачка интелигенција, уз учвршћивање заједнице на три континента. То су планови из мапе пута: датуми и доступност објављују се искључиво путем званичних канала — сваки датум који видиш другде узми са опрезом.',
      ur: 'سرکاری مواد اپنے ٹیکنالوجی روڈ میپ میں AiG Token کے روزمرہ استعمال کے لیے Visa / Mastercard ادائیگی نظاموں کے ساتھ انضمام، اور AI سے چلنے والی خدمات کے ساتھ ایک تعلیمی پلیٹ فارم (اکیڈمی) کا ذکر کرتا ہے، نیز تین براعظموں میں کمیونٹی کو مضبوط کرنے کا۔ یہ روڈ میپ کے منصوبے ہیں: تاریخیں اور دستیابی صرف سرکاری چینلز پر بتائی جاتی ہیں — کہیں اور دیکھی گئی کسی بھی تاریخ کو احتیاط سے لیں۔',
    },

  /* ══════════════════════════════════════════════════════════════════
     CORPUS · CUENTA, TIENDA Y PANEL

     TRES NEGATIVAS QUE NO SE SUAVIZAN. «La wallet NO se cambia» protege contra
     el fraude más barato que existe: un mensaje pidiendo cobrar en otra
     dirección. Y las dos respuestas que dicen «todavía no está documentado»
     (facturación y alertas) valen justamente por lo que NO hacen: una versión
     traducida que invente una ruta de pantallas convierte una guía honesta en
     una guía falsa en diez idiomas a la vez.

     «SIN LOS HASHES NO SE PUEDE RECONSTRUIR» se mantiene como cierre seco en
     los once. Es la frase que hace que la persona junte la prueba antes de
     escribir, en vez de mandar un reclamo que nadie puede investigar.
     ══════════════════════════════════════════════════════════════════ */
  'El total minado que muestra mi cuenta no me cuadra': {
    en: 'The total mined shown in my account doesn’t add up',
    pt: 'O total minerado que minha conta mostra não bate',
    fr: 'Le total miné affiché sur mon compte ne correspond pas',
    ru: 'Общая сумма намайненного в моём аккаунте не сходится',
    sv: 'Den totala miningen som mitt konto visar stämmer inte',
    hr: 'Ukupno izrudareno koje prikazuje moj račun ne štima',
    ar: 'إجمالي التعدين الظاهر في حسابي غير مطابق',
    de: 'Die in meinem Konto angezeigte Mining-Summe stimmt nicht',
    sr: 'Укупно израдарено које приказује мој налог не штима',
    ur: 'میرے اکاؤنٹ میں دکھایا گیا کل مائنڈ درست نہیں لگتا',
  },
  'Es un caso para el equipo y conviene reportarlo bien, porque esa cifra es la base sobre la que se calcula tu hold: si el total minado está mal, el mínimo que te piden también. Manda tu usuario, tu correo, la cantidad que muestra la plataforma, la que tú calculas y el hash de las transacciones que la sostienen. Sin los hashes no se puede reconstruir.':
    {
      en: 'This is a case for the team and it pays to report it properly, because that figure is the basis on which your hold is calculated: if the total mined is wrong, so is the minimum they ask of you. Send your username, your email, the amount the platform shows, the amount you calculate, and the hashes of the transactions behind it. Without the hashes it cannot be reconstructed.',
      pt: 'É um caso para a equipe e convém reportá-lo bem, porque esse número é a base sobre a qual se calcula seu hold: se o total minerado está errado, o mínimo que te pedem também. Envie seu usuário, seu e-mail, o valor que a plataforma mostra, o que você calcula e o hash das transações que o sustentam. Sem os hashes não dá para reconstruir.',
      fr: 'C’est un cas pour l’équipe et il vaut mieux le signaler correctement, car ce chiffre est la base sur laquelle se calcule ton hold : si le total miné est faux, le minimum qu’on te demande l’est aussi. Envoie ton identifiant, ton e-mail, le montant affiché par la plateforme, celui que tu calcules et le hash des transactions qui le soutiennent. Sans les hash, impossible de reconstituer.',
      ru: 'Это случай для команды, и сообщить о нём стоит как следует, потому что эта цифра — основа расчёта твоего холда: если общий намайненный объём неверен, то и требуемый минимум тоже. Пришли свой логин, почту, сумму, которую показывает платформа, сумму, которую считаешь ты, и хеши транзакций, на которых она держится. Без хешей восстановить невозможно.',
      sv: 'Det är ett ärende för teamet och det lönar sig att rapportera det ordentligt, eftersom den siffran är grunden för hur ditt hold beräknas: om den totala miningen är fel är även minimikravet fel. Skicka ditt användarnamn, din e-post, beloppet plattformen visar, beloppet du räknar fram och hasharna för de transaktioner som ligger bakom. Utan hasharna går det inte att rekonstruera.',
      hr: 'To je slučaj za tim i isplati se prijaviti ga kako treba, jer je ta brojka temelj po kojem se računa tvoj hold: ako je ukupno izrudareno krivo, krivi je i minimum koji ti traže. Pošalji svoje korisničko ime, e-poštu, iznos koji prikazuje platforma, iznos koji ti izračunaš i hasheve transakcija koje ga potkrepljuju. Bez hasheva se ne može rekonstruirati.',
      ar: 'هذه حالة تخص الفريق ويُستحسن الإبلاغ عنها جيدًا، لأن ذلك الرقم هو الأساس الذي يُحسب عليه الـ hold الخاص بك: إذا كان إجمالي التعدين خاطئًا، فالحد الأدنى المطلوب منك خاطئ أيضًا. أرسل اسم المستخدم وبريدك الإلكتروني والمبلغ الذي تعرضه المنصّة والمبلغ الذي تحسبه أنت وهاشات المعاملات التي تسنده. بدون الهاشات لا يمكن إعادة البناء.',
      de: 'Das ist ein Fall fürs Team, und es lohnt sich, ihn sauber zu melden, denn diese Zahl ist die Grundlage, auf der dein Hold berechnet wird: Ist die Mining-Summe falsch, ist auch das geforderte Minimum falsch. Schick deinen Benutzernamen, deine E-Mail, den Betrag, den die Plattform anzeigt, den Betrag, den du errechnest, und die Hashes der Transaktionen, die ihn belegen. Ohne die Hashes lässt sich nichts rekonstruieren.',
      sr: 'То је случај за тим и исплати се пријавити га како треба, јер је та бројка темељ по којем се рачуна твој hold: ако је укупно израдарено погрешно, погрешан је и минимум који ти траже. Пошаљи своје корисничко име, е-пошту, износ који приказује платформа, износ који ти израчунаш и хешеве трансакција које га поткрепљују. Без хешева се не може реконструисати.',
      ur: 'یہ ٹیم کا معاملہ ہے اور اسے ٹھیک طرح رپورٹ کرنا بہتر ہے، کیونکہ یہ عدد آپ کے hold کے حساب کی بنیاد ہے: اگر کل مائنڈ غلط ہے تو آپ سے مانگا جانے والا کم از کم بھی غلط ہے۔ اپنا یوزر نیم، ای میل، پلیٹ فارم پر دکھائی دینے والی رقم، آپ کے حساب سے بننے والی رقم، اور ان ٹرانزیکشنز کے ہیش بھیجیں جن پر یہ قائم ہے۔ ہیش کے بغیر دوبارہ تشکیل ممکن نہیں۔',
    },
  /* La PREGUNTA «¿Puedo cambiar la wallet de mi cuenta?» ya estaba traducida
     arriba, en el bloque de Hold; sólo faltaba su respuesta. */
  'No. La wallet de una cuenta no se cambia: es la dirección donde se liquida lo que le corresponde, y reasignarla a petición convertiría un mensaje en una orden de pago a otra dirección. Si perdiste el acceso a tu wallet, es un caso para el equipo, y no existe ningún trámite que reasigne la cuenta a otra dirección porque se pida.':
    {
      en: 'No. An account’s wallet is not changed: it is the address where what belongs to it is settled, and reassigning it on request would turn a message into a payment order to a different address. If you lost access to your wallet, that is a case for the team, and there is no procedure that reassigns the account to another address just because it was asked for.',
      pt: 'Não. A wallet de uma conta não se muda: é o endereço onde se liquida o que lhe corresponde, e reatribuí-la a pedido transformaria uma mensagem em uma ordem de pagamento para outro endereço. Se você perdeu o acesso à sua wallet, é um caso para a equipe, e não existe nenhum trâmite que reatribua a conta a outro endereço só porque foi pedido.',
      fr: 'Non. La wallet d’un compte ne se change pas : c’est l’adresse où est réglé ce qui lui revient, et la réattribuer sur demande transformerait un message en ordre de paiement vers une autre adresse. Si tu as perdu l’accès à ta wallet, c’est un cas pour l’équipe, et aucune démarche ne réattribue le compte à une autre adresse simplement parce qu’on le demande.',
      ru: 'Нет. Кошелёк аккаунта не меняется: это адрес, на который выплачивается всё причитающееся, и переназначение по просьбе превратило бы сообщение в платёжное поручение на другой адрес. Если ты потерял доступ к кошельку — это случай для команды, и не существует процедуры, которая переназначает аккаунт на другой адрес просто потому, что об этом попросили.',
      sv: 'Nej. Ett kontos plånbok byts inte: det är adressen där det som tillhör kontot regleras, och att omfördela den på begäran skulle förvandla ett meddelande till en betalningsorder till en annan adress. Om du förlorat åtkomsten till din plånbok är det ett ärende för teamet, och det finns ingen rutin som flyttar kontot till en annan adress bara för att någon ber om det.',
      hr: 'Ne. Novčanik računa se ne mijenja: to je adresa na kojoj se namiruje ono što računu pripada, a preraspoređivanje na zahtjev pretvorilo bi poruku u nalog za plaćanje na drugu adresu. Ako si izgubio pristup svom novčaniku, to je slučaj za tim, i ne postoji nikakav postupak koji račun dodjeljuje drugoj adresi samo zato što se to zatražilo.',
      ar: 'لا. محفظة الحساب لا تُغيَّر: هي العنوان الذي تُسوَّى فيه مستحقاته، وإعادة تعيينها بناءً على طلب تحوّل رسالةً إلى أمر دفع لعنوان آخر. إن فقدت الوصول إلى محفظتك فهذه حالة تخص الفريق، ولا يوجد أي إجراء يعيد تعيين الحساب لعنوان آخر لمجرد أنه طُلب.',
      de: 'Nein. Die Wallet eines Kontos wird nicht geändert: Sie ist die Adresse, auf der abgerechnet wird, was dem Konto zusteht, und eine Neuzuweisung auf Zuruf würde eine Nachricht in eine Zahlungsanweisung an eine andere Adresse verwandeln. Wenn du den Zugang zu deiner Wallet verloren hast, ist das ein Fall fürs Team — und es gibt kein Verfahren, das ein Konto einer anderen Adresse zuweist, nur weil danach gefragt wurde.',
      sr: 'Не. Новчаник налога се не мења: то је адреса на којој се намирује оно што налогу припада, а прерасподела на захтев претворила би поруку у налог за плаћање на другу адресу. Ако си изгубио приступ свом новчанику, то је случај за тим, и не постоји никакав поступак који налог додељује другој адреси само зато што се то затражило.',
      ur: 'نہیں۔ اکاؤنٹ کا والٹ تبدیل نہیں ہوتا: یہ وہ پتہ ہے جہاں اکاؤنٹ کا واجب الادا ادا کیا جاتا ہے، اور درخواست پر اسے بدلنا ایک پیغام کو کسی دوسرے پتے پر ادائیگی کے حکم میں بدل دے گا۔ اگر آپ نے اپنے والٹ تک رسائی کھو دی ہے تو یہ ٹیم کا معاملہ ہے، اور ایسا کوئی طریقہ کار موجود نہیں جو صرف مانگنے پر اکاؤنٹ کو کسی اور پتے سے جوڑ دے۔',
    },
  '¿Cómo es la compra de principio a fin, paso a paso?': {
    en: 'What does a purchase look like from start to finish, step by step?',
    pt: 'Como é a compra do começo ao fim, passo a passo?',
    fr: 'Comment se déroule un achat du début à la fin, étape par étape ?',
    ru: 'Как выглядит покупка от начала до конца, шаг за шагом?',
    sv: 'Hur ser ett köp ut från början till slut, steg för steg?',
    hr: 'Kako izgleda kupnja od početka do kraja, korak po korak?',
    ar: 'كيف تسير عملية الشراء من البداية إلى النهاية، خطوة بخطوة؟',
    de: 'Wie läuft ein Kauf von Anfang bis Ende ab, Schritt für Schritt?',
    sr: 'Како изгледа куповина од почетка до краја, корак по корак?',
    ur: 'خریداری شروع سے آخر تک، قدم بہ قدم کیسے ہوتی ہے؟',
  },
  'De punta a punta: 1) Entras a la tienda con tu cuenta de Genesis y conectas tu wallet en la red BSC. 2) Buscas o navegas el catálogo y abres la ficha del producto. 3) Lo agregas al carrito (puedes seguir sumando artículos). 4) En la caja pones la dirección de envío —queda guardada— y eliges la forma de pago: DUAL (AIG + USDT) o USDT solo. 5) Revisas el total, que ya incluye el envío, y confirmas firmando desde tu wallet. 6) Ves la confirmación del pedido, y a partir de ahí lo sigues desde «Mis pedidos» con avisos en pagado, enviado, en tránsito y entregado. Si algo no cuadra en el total antes de firmar, no confirmes.':
    {
      en: 'End to end: 1) You enter the store with your Genesis account and connect your wallet on the BSC network. 2) You search or browse the catalog and open the product page. 3) You add it to the cart (you can keep adding items). 4) At checkout you enter the shipping address — it is saved — and choose the payment method: DUAL (AIG + USDT) or USDT only. 5) You review the total, which already includes shipping, and confirm by signing from your wallet. 6) You see the order confirmation, and from there you follow it in “My orders” with notices at paid, shipped, in transit and delivered. If anything about the total looks off before you sign, do not confirm.',
      pt: 'De ponta a ponta: 1) Você entra na loja com sua conta Genesis e conecta sua wallet na rede BSC. 2) Busca ou navega o catálogo e abre a ficha do produto. 3) Adiciona ao carrinho (pode continuar somando itens). 4) No checkout coloca o endereço de entrega —fica salvo— e escolhe a forma de pagamento: DUAL (AIG + USDT) ou só USDT. 5) Revisa o total, que já inclui o frete, e confirma assinando pela sua wallet. 6) Vê a confirmação do pedido, e a partir daí acompanha em «Meus pedidos» com avisos em pago, enviado, em trânsito e entregue. Se algo não bater no total antes de assinar, não confirme.',
      fr: 'De bout en bout : 1) Tu entres dans la boutique avec ton compte Genesis et connectes ta wallet sur le réseau BSC. 2) Tu cherches ou parcours le catalogue et ouvres la fiche du produit. 3) Tu l’ajoutes au panier (tu peux continuer d’ajouter des articles). 4) À la caisse tu saisis l’adresse de livraison — elle est enregistrée — et choisis le mode de paiement : DUAL (AIG + USDT) ou USDT seul. 5) Tu vérifies le total, qui inclut déjà la livraison, et confirmes en signant depuis ta wallet. 6) Tu vois la confirmation de commande, et tu la suis ensuite depuis « Mes commandes » avec des avis à payé, expédié, en transit et livré. Si quelque chose cloche dans le total avant de signer, ne confirme pas.',
      ru: 'От начала до конца: 1) Заходишь в магазин со своим аккаунтом Genesis и подключаешь кошелёк в сети BSC. 2) Ищешь или просматриваешь каталог и открываешь карточку товара. 3) Добавляешь в корзину (можно добавлять ещё). 4) На кассе указываешь адрес доставки — он сохраняется — и выбираешь способ оплаты: DUAL (AIG + USDT) или только USDT. 5) Проверяешь итог, в который уже входит доставка, и подтверждаешь, подписывая из кошелька. 6) Видишь подтверждение заказа, а дальше следишь за ним в «Моих заказах» с уведомлениями на этапах оплачен, отправлен, в пути и доставлен. Если что-то в итоговой сумме не сходится до подписи — не подтверждай.',
      sv: 'Från början till slut: 1) Du går in i butiken med ditt Genesis-konto och ansluter din plånbok på BSC-nätverket. 2) Du söker eller bläddrar i katalogen och öppnar produktsidan. 3) Du lägger den i kundvagnen (du kan fortsätta lägga till varor). 4) I kassan anger du leveransadressen — den sparas — och väljer betalsätt: DUAL (AIG + USDT) eller enbart USDT. 5) Du granskar summan, som redan inkluderar frakt, och bekräftar genom att signera från din plånbok. 6) Du ser orderbekräftelsen, och följer den sedan under ”Mina beställningar” med aviseringar vid betald, skickad, under transport och levererad. Om något i summan inte stämmer innan du signerar — bekräfta inte.',
      hr: 'S kraja na kraj: 1) Ulaziš u trgovinu svojim Genesis računom i povezuješ novčanik na mreži BSC. 2) Tražiš ili pregledavaš katalog i otvaraš karticu proizvoda. 3) Dodaješ ga u košaricu (možeš nastaviti dodavati artikle). 4) Na blagajni upisuješ adresu dostave — sprema se — i biraš način plaćanja: DUAL (AIG + USDT) ili samo USDT. 5) Provjeravaš ukupan iznos, koji već uključuje dostavu, i potvrđuješ potpisom iz novčanika. 6) Vidiš potvrdu narudžbe, a dalje je pratiš u «Moje narudžbe» s obavijestima na plaćeno, poslano, u prijevozu i dostavljeno. Ako nešto u ukupnom iznosu ne štima prije potpisa, nemoj potvrditi.',
      ar: 'من البداية إلى النهاية: 1) تدخل المتجر بحسابك في Genesis وتربط محفظتك على شبكة BSC. 2) تبحث أو تتصفح الكتالوج وتفتح صفحة المنتج. 3) تضيفه إلى السلة (يمكنك متابعة إضافة العناصر). 4) عند الدفع تُدخل عنوان الشحن — ويُحفظ — وتختار طريقة الدفع: DUAL ‏(AIG + USDT) أو USDT فقط. 5) تراجع الإجمالي، وهو يشمل الشحن أصلًا، وتؤكّد بالتوقيع من محفظتك. 6) ترى تأكيد الطلب، ثم تتابعه من «طلباتي» بإشعارات عند مدفوع ومُرسَل وفي الطريق ومُسلَّم. إذا لم يكن الإجمالي مطابقًا قبل التوقيع، فلا تؤكّد.',
      de: 'Von Anfang bis Ende: 1) Du betrittst den Shop mit deinem Genesis-Konto und verbindest deine Wallet im BSC-Netzwerk. 2) Du suchst oder stöberst im Katalog und öffnest die Produktseite. 3) Du legst es in den Warenkorb (du kannst weitere Artikel hinzufügen). 4) An der Kasse gibst du die Lieferadresse ein — sie wird gespeichert — und wählst die Zahlungsart: DUAL (AIG + USDT) oder nur USDT. 5) Du prüfst die Summe, in der der Versand bereits enthalten ist, und bestätigst durch Signieren aus deiner Wallet. 6) Du siehst die Bestellbestätigung und verfolgst sie danach unter „Meine Bestellungen“ mit Hinweisen bei bezahlt, versandt, unterwegs und zugestellt. Wenn an der Summe vor dem Signieren etwas nicht stimmt: nicht bestätigen.',
      sr: 'С краја на крај: 1) Улазиш у продавницу својим Genesis налогом и повезујеш новчаник на мрежи BSC. 2) Тражиш или прегледаш каталог и отвараш картицу производа. 3) Додајеш га у корпу (можеш наставити да додајеш артикле). 4) На каси уписујеш адресу доставе — чува се — и бираш начин плаћања: DUAL (AIG + USDT) или само USDT. 5) Провераваш укупан износ, који већ укључује доставу, и потврђујеш потписом из новчаника. 6) Видиш потврду поруџбине, а даље је пратиш у «Моје поруџбине» са обавештењима на плаћено, послато, у превозу и испоручено. Ако нешто у укупном износу не штима пре потписа, немој потврдити.',
      ur: 'شروع سے آخر تک: 1) آپ اپنے Genesis اکاؤنٹ سے اسٹور میں داخل ہوتے ہیں اور BSC نیٹ ورک پر اپنا والٹ جوڑتے ہیں۔ 2) کیٹلاگ میں تلاش یا براؤز کر کے پروڈکٹ کا صفحہ کھولتے ہیں۔ 3) اسے کارٹ میں شامل کرتے ہیں (مزید اشیاء بھی شامل کر سکتے ہیں)۔ 4) چیک آؤٹ پر ترسیل کا پتہ درج کرتے ہیں — یہ محفوظ ہو جاتا ہے — اور ادائیگی کا طریقہ چنتے ہیں: DUAL ‏(AIG + USDT) یا صرف USDT۔ 5) کل رقم دیکھتے ہیں، جس میں ترسیل شامل ہے، اور اپنے والٹ سے دستخط کر کے تصدیق کرتے ہیں۔ 6) آرڈر کی تصدیق نظر آتی ہے، اور پھر «میرے آرڈرز» میں ادا شدہ، بھیجا گیا، راستے میں اور پہنچا دیا گیا پر اطلاعات کے ساتھ اسے ٹریک کرتے ہیں۔ اگر دستخط سے پہلے کل رقم میں کچھ ٹھیک نہ لگے تو تصدیق نہ کریں۔',
    },
  '¿Qué herramientas o portales tengo como comprador?': {
    en: 'What tools or portals do I have as a buyer?',
    pt: 'Que ferramentas ou portais tenho como comprador?',
    fr: 'Quels outils ou portails ai-je en tant qu’acheteur ?',
    ru: 'Какие инструменты или порталы есть у меня как у покупателя?',
    sv: 'Vilka verktyg eller portaler har jag som köpare?',
    hr: 'Koje alate ili portale imam kao kupac?',
    ar: 'ما الأدوات أو البوابات المتاحة لي كمشترٍ؟',
    de: 'Welche Werkzeuge oder Portale habe ich als Käufer?',
    sr: 'Које алате или портале имам као купац?',
    ur: 'بطور خریدار مجھے کون سے ٹولز یا پورٹل دستیاب ہیں؟',
  },
  'Todo con tu misma cuenta de Genesis: el buscador y el catálogo por categorías para descubrir productos; la ficha de cada producto con su detalle; el carrito para juntar lo que vas a llevar; la lista de deseos para guardar lo que te interesa; y «Mis pedidos», donde ves cada compra, retomas un pago que quedó a medias y sigues el estado del envío paso a paso. No hay portales aparte ni contraseñas distintas: es la misma sesión del ecosistema.':
    {
      en: 'All with the same Genesis account: the search and the catalog by categories to discover products; each product’s page with its detail; the cart to gather what you are taking; the wishlist to save what interests you; and “My orders”, where you see every purchase, resume a payment left halfway and follow the shipping status step by step. There are no separate portals or different passwords: it is the same ecosystem session.',
      pt: 'Tudo com a sua mesma conta Genesis: a busca e o catálogo por categorias para descobrir produtos; a ficha de cada produto com seu detalhe; o carrinho para juntar o que vai levar; a lista de desejos para guardar o que te interessa; e «Meus pedidos», onde vê cada compra, retoma um pagamento que ficou pela metade e acompanha o estado do envio passo a passo. Não há portais à parte nem senhas diferentes: é a mesma sessão do ecossistema.',
      fr: 'Tout avec ton même compte Genesis : la recherche et le catalogue par catégories pour découvrir des produits ; la fiche de chaque produit avec son détail ; le panier pour rassembler ce que tu emportes ; la liste de souhaits pour garder ce qui t’intéresse ; et « Mes commandes », où tu vois chaque achat, reprends un paiement resté à mi-chemin et suis l’état de la livraison étape par étape. Pas de portails à part ni de mots de passe différents : c’est la même session de l’écosystème.',
      ru: 'Всё под тем же аккаунтом Genesis: поиск и каталог по категориям, чтобы находить товары; карточка каждого товара с подробностями; корзина, чтобы собрать покупку; список желаний, чтобы сохранить интересное; и «Мои заказы», где видна каждая покупка, можно продолжить незавершённую оплату и шаг за шагом следить за доставкой. Отдельных порталов и других паролей нет: это одна и та же сессия экосистемы.',
      sv: 'Allt med samma Genesis-konto: sökningen och katalogen efter kategorier för att upptäcka produkter; varje produkts sida med detaljerna; kundvagnen för att samla det du ska ta; önskelistan för att spara det du är intresserad av; och ”Mina beställningar”, där du ser varje köp, återupptar en betalning som blev halvfärdig och följer leveransstatusen steg för steg. Inga separata portaler eller andra lösenord: det är samma session i ekosystemet.',
      hr: 'Sve s tvojim istim Genesis računom: tražilica i katalog po kategorijama za otkrivanje proizvoda; kartica svakog proizvoda s detaljima; košarica za skupljanje onoga što nosiš; lista želja za spremanje onoga što te zanima; i «Moje narudžbe», gdje vidiš svaku kupnju, nastavljaš plaćanje koje je ostalo na pola i pratiš status dostave korak po korak. Nema odvojenih portala ni drugih lozinki: to je ista sesija ekosustava.',
      ar: 'كل شيء بحسابك نفسه في Genesis: البحث والكتالوج حسب الفئات لاكتشاف المنتجات؛ صفحة كل منتج بتفاصيله؛ السلة لتجميع ما ستأخذه؛ قائمة الرغبات لحفظ ما يهمّك؛ و«طلباتي» حيث ترى كل عملية شراء، وتستأنف دفعة توقفت في المنتصف، وتتابع حالة الشحن خطوة بخطوة. لا توجد بوابات منفصلة ولا كلمات مرور مختلفة: إنها الجلسة نفسها في النظام البيئي.',
      de: 'Alles mit demselben Genesis-Konto: die Suche und der Katalog nach Kategorien, um Produkte zu entdecken; die Seite jedes Produkts mit den Details; der Warenkorb, um zusammenzutragen, was du mitnimmst; die Wunschliste, um Interessantes zu sichern; und „Meine Bestellungen“, wo du jeden Kauf siehst, eine halb gebliebene Zahlung wieder aufnimmst und den Versandstatus Schritt für Schritt verfolgst. Es gibt keine getrennten Portale und keine anderen Passwörter: Es ist dieselbe Sitzung des Ökosystems.',
      sr: 'Све са твојим истим Genesis налогом: претрага и каталог по категоријама за откривање производа; картица сваког производа са детаљима; корпа за скупљање онога што носиш; листа жеља за чување онога што те занима; и «Моје поруџбине», где видиш сваку куповину, настављаш плаћање које је остало на пола и пратиш статус доставе корак по корак. Нема одвојених портала ни других лозинки: то је иста сесија екосистема.',
      ur: 'سب کچھ آپ کے اسی Genesis اکاؤنٹ سے: پروڈکٹس دریافت کرنے کے لیے سرچ اور کیٹیگری کے حساب سے کیٹلاگ؛ ہر پروڈکٹ کا تفصیلی صفحہ؛ جو لے جانا ہے اسے جمع کرنے کے لیے کارٹ؛ پسندیدہ چیزیں محفوظ کرنے کے لیے وش لسٹ؛ اور «میرے آرڈرز»، جہاں آپ ہر خریداری دیکھتے ہیں، ادھوری رہ جانے والی ادائیگی دوبارہ شروع کرتے ہیں اور ترسیل کی حالت قدم بہ قدم دیکھتے ہیں۔ کوئی الگ پورٹل یا الگ پاس ورڈ نہیں: یہ ایکو سسٹم کا وہی سیشن ہے۔',
    },
  '¿Puedo facturar mi compra con datos fiscales?': {
    en: 'Can I invoice my purchase with tax details?',
    pt: 'Posso faturar minha compra com dados fiscais?',
    fr: 'Puis-je facturer mon achat avec des données fiscales ?',
    ru: 'Могу ли я получить счёт на покупку с налоговыми данными?',
    sv: 'Kan jag fakturera mitt köp med skatteuppgifter?',
    hr: 'Mogu li izdati račun za kupnju s poreznim podacima?',
    ar: 'هل يمكنني إصدار فاتورة لشرائي ببيانات ضريبية؟',
    de: 'Kann ich meinen Kauf mit Steuerdaten in Rechnung stellen lassen?',
    sr: 'Могу ли издати рачун за куповину са пореским подацима?',
    ur: 'کیا میں اپنی خریداری کا ٹیکس تفصیلات کے ساتھ انوائس بنوا سکتا ہوں؟',
  },
  'La facturación con datos fiscales todavía no está documentada aquí, y preferimos decírtelo a improvisarte un procedimiento. Escríbenos por el canal oficial con tu usuario y el número de pedido, y el equipo te confirma qué comprobantes puede emitir para tu caso y tu país.':
    {
      en: 'Invoicing with tax details is not yet documented here, and we would rather tell you that than improvise a procedure for you. Write to us through the official channel with your username and order number, and the team will confirm which documents it can issue for your case and your country.',
      pt: 'A emissão de nota com dados fiscais ainda não está documentada aqui, e preferimos te dizer isso a improvisar um procedimento. Escreva pelo canal oficial com seu usuário e o número do pedido, e a equipe confirma quais comprovantes pode emitir para seu caso e seu país.',
      fr: 'La facturation avec des données fiscales n’est pas encore documentée ici, et nous préférons te le dire plutôt que t’improviser une procédure. Écris-nous par le canal officiel avec ton identifiant et le numéro de commande, et l’équipe te confirmera quels justificatifs elle peut émettre pour ton cas et ton pays.',
      ru: 'Выставление счёта с налоговыми данными здесь ещё не описано, и мы предпочитаем сказать это, а не выдумывать тебе процедуру. Напиши нам по официальному каналу с логином и номером заказа, и команда подтвердит, какие документы может выдать для твоего случая и твоей страны.',
      sv: 'Fakturering med skatteuppgifter är ännu inte dokumenterad här, och vi säger hellre det än improviserar en rutin åt dig. Skriv till oss via den officiella kanalen med ditt användarnamn och ordernumret, så bekräftar teamet vilka underlag det kan utfärda för ditt fall och ditt land.',
      hr: 'Izdavanje računa s poreznim podacima ovdje još nije dokumentirano, i radije ti to kažemo nego da ti improviziramo postupak. Piši nam službenim kanalom sa svojim korisničkim imenom i brojem narudžbe, a tim će ti potvrditi koje dokumente može izdati za tvoj slučaj i tvoju zemlju.',
      ar: 'إصدار الفواتير بالبيانات الضريبية غير موثّق هنا بعد، ونفضّل إخبارك بذلك على أن نرتجل لك إجراءً. راسلنا عبر القناة الرسمية باسم المستخدم ورقم الطلب، وسيؤكّد لك الفريق ما يمكنه إصداره من مستندات لحالتك وبلدك.',
      de: 'Die Rechnungsstellung mit Steuerdaten ist hier noch nicht dokumentiert, und wir sagen dir das lieber, als dir ein Verfahren zu improvisieren. Schreib uns über den offiziellen Kanal mit deinem Benutzernamen und der Bestellnummer, dann bestätigt dir das Team, welche Belege es für deinen Fall und dein Land ausstellen kann.',
      sr: 'Издавање рачуна са пореским подацима овде још није документовано, и радије ти то кажемо него да ти импровизујемо поступак. Пиши нам званичним каналом са својим корисничким именом и бројем поруџбине, а тим ће ти потврдити које документе може издати за твој случај и твоју земљу.',
      ur: 'ٹیکس تفصیلات کے ساتھ انوائسنگ ابھی یہاں دستاویزی نہیں ہے، اور ہم آپ کے لیے کوئی طریقہ کار گھڑنے کے بجائے یہ بتانا بہتر سمجھتے ہیں۔ سرکاری چینل پر اپنے یوزر نیم اور آرڈر نمبر کے ساتھ ہمیں لکھیں، اور ٹیم آپ کے کیس اور ملک کے لیے تصدیق کرے گی کہ وہ کون سی دستاویزات جاری کر سکتی ہے۔',
    },
  '¿Cómo configuro mis alertas?': {
    en: 'How do I set up my alerts?', pt: 'Como configuro meus alertas?',
    fr: 'Comment configurer mes alertes ?', ru: 'Как настроить мои оповещения?',
    sv: 'Hur ställer jag in mina aviseringar?', hr: 'Kako podešavam svoja upozorenja?',
    ar: 'كيف أضبط تنبيهاتي؟', de: 'Wie richte ich meine Benachrichtigungen ein?',
    sr: 'Како подешавам своја упозорења?', ur: 'میں اپنے الرٹس کیسے سیٹ کروں؟',
  },

  /* ══════════════════════════════════════════════════════════════════
     CORPUS · MINERÍA, BOOSTER, STAKING Y G-PULSE

     LAS TASAS SON TASAS DE EMISIÓN, y cada respuesta lo dice al final. Esa
     coletilla es lo único que separa «el protocolo emite un 8% mensual» de una
     promesa de rendimiento, y traducirla flojo la convierte en la segunda. Va
     entera en los once idiomas, no resumida.

     LOS NÚMEROS NO SE LOCALIZAN A OTRA COSA: 8%, 14%, 200%, 250%, 20 USDT, 10
     USDT y la escala del staking (1/3/6/9/12 meses → 6/8/10/12/15%) son los
     mismos en todos. Sólo cambia el separador decimal donde el idioma lo pide.

     Y LAS DOS FRASES QUE EVITAN PERDER DINERO se mantienen literales: «si
     pagaste y no se refleja, NO repitas la compra — guarda el hash» y, en
     G-Pulse, «tú decides los parámetros y asumes el resultado».
     ══════════════════════════════════════════════════════════════════ */
  /* La PREGUNTA de la minería ya estaba traducida arriba, en el bloque de
     Minería; lo que faltaba era el paso a paso. */
  'La minería genera AiG Token a diario. Pasos: 1) Entra a tu cuenta y ve a AiG Mining. 2) Elige un pack (desde 20 USDT). 3) Confirma la compra desde tu wallet (necesitas BNB para el gas). 4) A partir de ahí recibes emisión mensual —desde 8%— acreditada diariamente en AiG Token, hasta completar el 250% del pack. Ejemplo del material: minas con 100 USDT y el pack finaliza al llegar a 250 en AiG Token. Cuando termina, puedes retirar tus AiG o recomprar en más packs para acelerar. El 8% es una tasa de emisión del protocolo, no un resultado asegurado en dólares.':
    {
      en: 'Mining generates AiG Token daily. Steps: 1) Log in to your account and go to AiG Mining. 2) Choose a pack (from 20 USDT). 3) Confirm the purchase from your wallet (you need BNB for gas). 4) From then on you receive monthly emission — from 8% — credited daily in AiG Token, until the pack reaches 250%. Example from the material: you mine with 100 USDT and the pack finishes on reaching 250 in AiG Token. When it ends, you can withdraw your AiG or repurchase into more packs to accelerate. The 8% is a protocol emission rate, not an assured result in dollars.',
      pt: 'A mineração gera AiG Token diariamente. Passos: 1) Entre na sua conta e vá em AiG Mining. 2) Escolha um pack (a partir de 20 USDT). 3) Confirme a compra pela sua wallet (precisa de BNB para o gas). 4) A partir daí recebe emissão mensal —desde 8%— creditada diariamente em AiG Token, até completar 250% do pack. Exemplo do material: você minera com 100 USDT e o pack finaliza ao chegar a 250 em AiG Token. Quando termina, pode sacar seus AiG ou recomprar em mais packs para acelerar. Os 8% são uma taxa de emissão do protocolo, não um resultado assegurado em dólares.',
      fr: 'Le minage génère du AiG Token chaque jour. Étapes : 1) Connecte-toi à ton compte et va sur AiG Mining. 2) Choisis un pack (à partir de 20 USDT). 3) Confirme l’achat depuis ta wallet (il te faut du BNB pour le gas). 4) À partir de là tu reçois une émission mensuelle — dès 8 % — créditée quotidiennement en AiG Token, jusqu’à atteindre 250 % du pack. Exemple du matériel : tu mines avec 100 USDT et le pack se termine en atteignant 250 en AiG Token. À la fin, tu peux retirer tes AiG ou racheter d’autres packs pour accélérer. Les 8 % sont un taux d’émission du protocole, pas un résultat garanti en dollars.',
      ru: 'Майнинг ежедневно генерирует AiG Token. Шаги: 1) Зайди в аккаунт и открой AiG Mining. 2) Выбери пакет (от 20 USDT). 3) Подтверди покупку из кошелька (нужен BNB на газ). 4) С этого момента ты получаешь месячную эмиссию — от 8 % — начисляемую ежедневно в AiG Token, пока пакет не наберёт 250 %. Пример из материалов: майнишь со 100 USDT, и пакет завершается по достижении 250 в AiG Token. Когда он закончится, ты можешь вывести свои AiG или докупить пакеты, чтобы ускориться. 8 % — это ставка эмиссии протокола, а не гарантированный результат в долларах.',
      sv: 'Mining genererar AiG Token dagligen. Steg: 1) Logga in på ditt konto och gå till AiG Mining. 2) Välj ett paket (från 20 USDT). 3) Bekräfta köpet från din plånbok (du behöver BNB till gas). 4) Därefter får du en månatlig emission — från 8 % — som krediteras dagligen i AiG Token, tills paketet når 250 %. Exempel ur materialet: du minar med 100 USDT och paketet avslutas när det når 250 i AiG Token. När det tar slut kan du ta ut dina AiG eller återköpa fler paket för att accelerera. De 8 % är en emissionstakt i protokollet, inte ett säkrat resultat i dollar.',
      hr: 'Rudarenje svakodnevno stvara AiG Token. Koraci: 1) Uđi u svoj račun i idi na AiG Mining. 2) Odaberi paket (od 20 USDT). 3) Potvrdi kupnju iz svog novčanika (treba ti BNB za gas). 4) Od tada primaš mjesečnu emisiju —od 8 %— pripisanu dnevno u AiG Tokenu, dok paket ne dosegne 250 %. Primjer iz materijala: rudariš sa 100 USDT i paket završava kad dođe do 250 u AiG Tokenu. Kad završi, možeš podignuti svoje AiG ili ponovno kupiti još paketa da ubrzaš. Tih 8 % je stopa emisije protokola, a ne osiguran rezultat u dolarima.',
      ar: 'يولّد التعدين AiG Token يوميًا. الخطوات: 1) ادخل إلى حسابك واذهب إلى AiG Mining. 2) اختر باقة (ابتداءً من 20 USDT). 3) أكّد الشراء من محفظتك (تحتاج BNB للغاز). 4) من هناك تتلقى إصدارًا شهريًا —ابتداءً من 8٪— يُقيَّد يوميًا بالـ AiG Token، حتى تبلغ الباقة 250٪. مثال من المواد: تعدّن بـ 100 USDT وتنتهي الباقة عند بلوغ 250 بالـ AiG Token. عند انتهائها يمكنك سحب AiG أو إعادة الشراء بباقات أخرى للتسريع. الـ 8٪ نسبة إصدار في البروتوكول، وليست نتيجة مضمونة بالدولار.',
      de: 'Mining erzeugt täglich AiG Token. Schritte: 1) Melde dich in deinem Konto an und geh zu AiG Mining. 2) Wähle ein Paket (ab 20 USDT). 3) Bestätige den Kauf aus deiner Wallet (du brauchst BNB für das Gas). 4) Ab da erhältst du eine monatliche Emission — ab 8 % — täglich in AiG Token gutgeschrieben, bis das Paket 250 % erreicht. Beispiel aus dem Material: Du minst mit 100 USDT, und das Paket endet beim Erreichen von 250 in AiG Token. Wenn es endet, kannst du deine AiG abheben oder in weitere Pakete zurückkaufen, um zu beschleunigen. Die 8 % sind eine Emissionsrate des Protokolls, kein zugesichertes Ergebnis in Dollar.',
      sr: 'Рударење свакодневно ствара AiG Token. Кораци: 1) Уђи у свој налог и иди на AiG Mining. 2) Изабери пакет (од 20 USDT). 3) Потврди куповину из свог новчаника (треба ти BNB за гас). 4) Од тада примаш месечну емисију —од 8 %— приписану дневно у AiG Token-у, док пакет не достигне 250 %. Пример из материјала: рудариш са 100 USDT и пакет се завршава кад дође до 250 у AiG Token-у. Кад се заврши, можеш подићи своје AiG или поново купити још пакета да убрзаш. Тих 8 % је стопа емисије протокола, а не осигуран резултат у доларима.',
      ur: 'مائننگ روزانہ AiG Token پیدا کرتی ہے۔ اقدامات: 1) اپنے اکاؤنٹ میں جائیں اور AiG Mining کھولیں۔ 2) ایک پیک چنیں (20 USDT سے)۔ 3) اپنے والٹ سے خریداری کی تصدیق کریں (گیس کے لیے BNB درکار ہے)۔ 4) اس کے بعد آپ کو ماہانہ اجرا —8٪ سے— روزانہ AiG Token میں جمع ہوتا ہے، یہاں تک کہ پیک 250٪ تک پہنچ جائے۔ مواد کی مثال: آپ 100 USDT سے مائن کرتے ہیں اور پیک AiG Token میں 250 پر ختم ہوتا ہے۔ ختم ہونے پر آپ اپنے AiG نکال سکتے ہیں یا تیزی کے لیے مزید پیک خرید سکتے ہیں۔ 8٪ پروٹوکول کے اجرا کی شرح ہے، ڈالر میں یقینی نتیجہ نہیں۔',
    },
  '¿Cómo activo el Booster? Paso a paso': {
    en: 'How do I activate the Booster? Step by step',
    pt: 'Como ativo o Booster? Passo a passo',
    fr: 'Comment activer le Booster ? Étape par étape',
    ru: 'Как активировать Booster? Шаг за шагом',
    sv: 'Hur aktiverar jag Boostern? Steg för steg',
    hr: 'Kako aktiviram Booster? Korak po korak',
    ar: 'كيف أفعّل الـ Booster؟ خطوة بخطوة',
    de: 'Wie aktiviere ich den Booster? Schritt für Schritt',
    sr: 'Како активирам Booster? Корак по корак',
    ur: 'میں Booster کیسے فعال کروں؟ قدم بہ قدم',
  },
  'El Booster acelera tu crecimiento con una emisión mayor. Pasos: 1) En tu cuenta ve a AiG Booster. 2) Se activa con una mezcla: 80% en USDT + 20% en AiG Token. 3) Confirma desde tu wallet (con BNB para el gas). 4) Las recompensas se acumulan a diario en AiG Token —hasta 14% mensual— hasta completar el 200% del pack, y se convierten a USDT para retiro por el P2P. Ejemplo del material: activas 100 y recibes hasta 200 en AiG Token. Si pagaste y no se refleja, no repitas la compra: guarda el hash y aplica el paso a paso del reclamo.':
    {
      en: 'The Booster accelerates your growth with a higher emission. Steps: 1) In your account go to AiG Booster. 2) It is activated with a mix: 80% in USDT + 20% in AiG Token. 3) Confirm from your wallet (with BNB for gas). 4) Rewards accumulate daily in AiG Token — up to 14% monthly — until the pack reaches 200%, and they are converted to USDT for withdrawal via P2P. Example from the material: you activate 100 and receive up to 200 in AiG Token. If you paid and it is not reflected, do not repeat the purchase: save the hash and follow the claim step by step.',
      pt: 'O Booster acelera seu crescimento com uma emissão maior. Passos: 1) Na sua conta vá em AiG Booster. 2) Ativa-se com uma mistura: 80% em USDT + 20% em AiG Token. 3) Confirme pela sua wallet (com BNB para o gas). 4) As recompensas se acumulam diariamente em AiG Token —até 14% ao mês— até completar 200% do pack, e se convertem em USDT para saque pelo P2P. Exemplo do material: você ativa 100 e recebe até 200 em AiG Token. Se pagou e não se reflete, não repita a compra: guarde o hash e aplique o passo a passo da reclamação.',
      fr: 'Le Booster accélère ta croissance avec une émission plus élevée. Étapes : 1) Dans ton compte, va sur AiG Booster. 2) Il s’active avec un mélange : 80 % en USDT + 20 % en AiG Token. 3) Confirme depuis ta wallet (avec du BNB pour le gas). 4) Les récompenses s’accumulent chaque jour en AiG Token — jusqu’à 14 % par mois — jusqu’à atteindre 200 % du pack, et se convertissent en USDT pour retrait via le P2P. Exemple du matériel : tu actives 100 et reçois jusqu’à 200 en AiG Token. Si tu as payé et que rien n’apparaît, ne refais pas l’achat : garde le hash et applique la marche à suivre de la réclamation.',
      ru: 'Booster ускоряет твой рост за счёт большей эмиссии. Шаги: 1) В аккаунте открой AiG Booster. 2) Он активируется смесью: 80 % в USDT + 20 % в AiG Token. 3) Подтверди из кошелька (с BNB на газ). 4) Награды копятся ежедневно в AiG Token — до 14 % в месяц — пока пакет не наберёт 200 %, и конвертируются в USDT для вывода через P2P. Пример из материалов: активируешь 100 и получаешь до 200 в AiG Token. Если ты заплатил, а платёж не отражается, не повторяй покупку: сохрани хеш и действуй по шагам обращения.',
      sv: 'Boostern accelererar din tillväxt med en högre emission. Steg: 1) Gå till AiG Booster på ditt konto. 2) Den aktiveras med en blandning: 80 % i USDT + 20 % i AiG Token. 3) Bekräfta från din plånbok (med BNB till gas). 4) Belöningarna ackumuleras dagligen i AiG Token — upp till 14 % i månaden — tills paketet når 200 %, och omvandlas till USDT för uttag via P2P. Exempel ur materialet: du aktiverar 100 och får upp till 200 i AiG Token. Om du betalat och det inte syns — upprepa inte köpet: spara hashen och följ stegen för anmälan.',
      hr: 'Booster ubrzava tvoj rast većom emisijom. Koraci: 1) U svom računu idi na AiG Booster. 2) Aktivira se mješavinom: 80 % u USDT-u + 20 % u AiG Tokenu. 3) Potvrdi iz svog novčanika (s BNB-om za gas). 4) Nagrade se dnevno gomilaju u AiG Tokenu —do 14 % mjesečno— dok paket ne dosegne 200 %, i pretvaraju se u USDT za isplatu preko P2P-a. Primjer iz materijala: aktiviraš 100 i primaš do 200 u AiG Tokenu. Ako si platio a ne vidi se, nemoj ponavljati kupnju: spremi hash i primijeni korake reklamacije.',
      ar: 'يسرّع الـ Booster نموّك بإصدار أعلى. الخطوات: 1) في حسابك اذهب إلى AiG Booster. 2) يُفعَّل بمزيج: 80٪ بالـ USDT + 20٪ بالـ AiG Token. 3) أكّد من محفظتك (مع BNB للغاز). 4) تتراكم المكافآت يوميًا بالـ AiG Token —حتى 14٪ شهريًا— إلى أن تبلغ الباقة 200٪، وتُحوَّل إلى USDT للسحب عبر الـ P2P. مثال من المواد: تفعّل 100 وتتلقى حتى 200 بالـ AiG Token. إن دفعت ولم يظهر الأمر، فلا تكرّر الشراء: احفظ الهاش واتّبع خطوات المطالبة.',
      de: 'Der Booster beschleunigt dein Wachstum mit einer höheren Emission. Schritte: 1) Geh in deinem Konto zu AiG Booster. 2) Er wird mit einer Mischung aktiviert: 80 % in USDT + 20 % in AiG Token. 3) Bestätige aus deiner Wallet (mit BNB für das Gas). 4) Die Belohnungen sammeln sich täglich in AiG Token — bis zu 14 % monatlich — bis das Paket 200 % erreicht, und werden für die Auszahlung über P2P in USDT umgewandelt. Beispiel aus dem Material: Du aktivierst 100 und erhältst bis zu 200 in AiG Token. Wenn du bezahlt hast und nichts erscheint, wiederhole den Kauf nicht: Sichere den Hash und geh die Schritte der Reklamation durch.',
      sr: 'Booster убрзава твој раст већом емисијом. Кораци: 1) У свом налогу иди на AiG Booster. 2) Активира се мешавином: 80 % у USDT-у + 20 % у AiG Token-у. 3) Потврди из свог новчаника (са BNB-ом за гас). 4) Награде се дневно гомилају у AiG Token-у —до 14 % месечно— док пакет не достигне 200 %, и претварају се у USDT за исплату преко P2P-а. Пример из материјала: активираш 100 и примаш до 200 у AiG Token-у. Ако си платио а не види се, немој понављати куповину: сачувај хеш и примени кораке рекламације.',
      ur: 'Booster زیادہ اجرا کے ساتھ آپ کی ترقی تیز کرتا ہے۔ اقدامات: 1) اپنے اکاؤنٹ میں AiG Booster پر جائیں۔ 2) یہ ایک آمیزے سے فعال ہوتا ہے: 80٪ USDT + 20٪ AiG Token۔ 3) اپنے والٹ سے تصدیق کریں (گیس کے لیے BNB کے ساتھ)۔ 4) انعامات روزانہ AiG Token میں جمع ہوتے ہیں —ماہانہ 14٪ تک— یہاں تک کہ پیک 200٪ تک پہنچ جائے، اور P2P کے ذریعے نکالنے کے لیے USDT میں بدل جاتے ہیں۔ مواد کی مثال: آپ 100 فعال کرتے ہیں اور AiG Token میں 200 تک پاتے ہیں۔ اگر آپ نے ادائیگی کی اور وہ ظاہر نہ ہو تو خریداری نہ دہرائیں: ہیش محفوظ کریں اور شکایت کے اقدامات پر عمل کریں۔',
    },
  '¿Cómo hago staking de mis AiG? Paso a paso': {
    en: 'How do I stake my AiG? Step by step',
    pt: 'Como faço staking dos meus AiG? Passo a passo',
    fr: 'Comment faire du staking de mes AiG ? Étape par étape',
    ru: 'Как застейкать мои AiG? Шаг за шагом',
    sv: 'Hur stakar jag mina AiG? Steg för steg',
    hr: 'Kako stavljam svoje AiG u staking? Korak po korak',
    ar: 'كيف أضع AiG في الـ staking؟ خطوة بخطوة',
    de: 'Wie stake ich meine AiG? Schritt für Schritt',
    sr: 'Како стављам своје AiG у staking? Корак по корак',
    ur: 'میں اپنے AiG کا staking کیسے کروں؟ قدم بہ قدم',
  },
  'El staking bloquea tus AiG Token por un período y genera beneficios en AiG mientras haces holding. Pasos: 1) En tu cuenta ve a Staking. 2) Elige el período: cuanto más largo, mayor la tasa mensual — 1 mes 6%, 3 meses 8%, 6 meses 10%, 9 meses 12%, 12 meses 15%. 3) Confirma el bloqueo desde tu wallet. 4) Recibes los beneficios generados en AiG Token durante el período. Es la estrategia para quien acumula a largo plazo. Las tasas son de emisión del protocolo, no un resultado asegurado en dólares.':
    {
      en: 'Staking locks your AiG Token for a period and generates benefits in AiG while you hold. Steps: 1) In your account go to Staking. 2) Choose the period: the longer it is, the higher the monthly rate — 1 month 6%, 3 months 8%, 6 months 10%, 9 months 12%, 12 months 15%. 3) Confirm the lock from your wallet. 4) You receive the benefits generated in AiG Token during the period. It is the strategy for those who accumulate long term. The rates are protocol emission rates, not an assured result in dollars.',
      pt: 'O staking bloqueia seus AiG Token por um período e gera benefícios em AiG enquanto você faz holding. Passos: 1) Na sua conta vá em Staking. 2) Escolha o período: quanto mais longo, maior a taxa mensal — 1 mês 6%, 3 meses 8%, 6 meses 10%, 9 meses 12%, 12 meses 15%. 3) Confirme o bloqueio pela sua wallet. 4) Recebe os benefícios gerados em AiG Token durante o período. É a estratégia para quem acumula a longo prazo. As taxas são de emissão do protocolo, não um resultado assegurado em dólares.',
      fr: 'Le staking bloque tes AiG Token pour une période et génère des bénéfices en AiG pendant que tu détiens. Étapes : 1) Dans ton compte, va sur Staking. 2) Choisis la période : plus elle est longue, plus le taux mensuel est élevé — 1 mois 6 %, 3 mois 8 %, 6 mois 10 %, 9 mois 12 %, 12 mois 15 %. 3) Confirme le blocage depuis ta wallet. 4) Tu reçois les bénéfices générés en AiG Token pendant la période. C’est la stratégie pour qui accumule sur le long terme. Les taux sont des taux d’émission du protocole, pas un résultat garanti en dollars.',
      ru: 'Стейкинг блокирует твои AiG Token на срок и приносит выгоду в AiG, пока ты держишь. Шаги: 1) В аккаунте открой Staking. 2) Выбери срок: чем он длиннее, тем выше месячная ставка — 1 месяц 6 %, 3 месяца 8 %, 6 месяцев 10 %, 9 месяцев 12 %, 12 месяцев 15 %. 3) Подтверди блокировку из кошелька. 4) Ты получаешь выгоду, начисленную в AiG Token за период. Это стратегия для тех, кто копит вдолгую. Ставки — это ставки эмиссии протокола, а не гарантированный результат в долларах.',
      sv: 'Staking låser dina AiG Token under en period och genererar förmåner i AiG medan du håller. Steg: 1) Gå till Staking på ditt konto. 2) Välj perioden: ju längre, desto högre månadstakt — 1 månad 6 %, 3 månader 8 %, 6 månader 10 %, 9 månader 12 %, 12 månader 15 %. 3) Bekräfta låsningen från din plånbok. 4) Du får förmånerna som genereras i AiG Token under perioden. Det är strategin för den som samlar långsiktigt. Takterna är protokollets emissionstakter, inte ett säkrat resultat i dollar.',
      hr: 'Staking zaključava tvoje AiG Tokene na neko razdoblje i stvara dobitke u AiG-u dok držiš. Koraci: 1) U svom računu idi na Staking. 2) Odaberi razdoblje: što je dulje, to je mjesečna stopa veća — 1 mjesec 6 %, 3 mjeseca 8 %, 6 mjeseci 10 %, 9 mjeseci 12 %, 12 mjeseci 15 %. 3) Potvrdi zaključavanje iz svog novčanika. 4) Primaš dobitke ostvarene u AiG Tokenu tijekom razdoblja. To je strategija za onoga tko gomila dugoročno. Stope su stope emisije protokola, a ne osiguran rezultat u dolarima.',
      ar: 'يقفل الـ staking رموز AiG لديك لفترة ويولّد عوائد بالـ AiG ما دمت محتفظًا بها. الخطوات: 1) في حسابك اذهب إلى Staking. 2) اختر المدة: كلما طالت ارتفعت النسبة الشهرية — شهر واحد 6٪، 3 أشهر 8٪، 6 أشهر 10٪، 9 أشهر 12٪، 12 شهرًا 15٪. 3) أكّد القفل من محفظتك. 4) تتلقى العوائد المتولّدة بالـ AiG Token خلال المدة. هي استراتيجية من يراكم على المدى الطويل. النِّسب هي نسب إصدار في البروتوكول، وليست نتيجة مضمونة بالدولار.',
      de: 'Staking sperrt deine AiG Token für einen Zeitraum und erzeugt Erträge in AiG, während du hältst. Schritte: 1) Geh in deinem Konto zu Staking. 2) Wähle den Zeitraum: je länger, desto höher die Monatsrate — 1 Monat 6 %, 3 Monate 8 %, 6 Monate 10 %, 9 Monate 12 %, 12 Monate 15 %. 3) Bestätige die Sperre aus deiner Wallet. 4) Du erhältst die im Zeitraum in AiG Token erzeugten Erträge. Das ist die Strategie für alle, die langfristig ansammeln. Die Raten sind Emissionsraten des Protokolls, kein zugesichertes Ergebnis in Dollar.',
      sr: 'Staking закључава твоје AiG Token-е на неки период и ствара добитке у AiG-у док држиш. Кораци: 1) У свом налогу иди на Staking. 2) Изабери период: што је дужи, то је месечна стопа већа — 1 месец 6 %, 3 месеца 8 %, 6 месеци 10 %, 9 месеци 12 %, 12 месеци 15 %. 3) Потврди закључавање из свог новчаника. 4) Примаш добитке остварене у AiG Token-у током периода. То је стратегија за онога ко гомила дугорочно. Стопе су стопе емисије протокола, а не осигуран резултат у доларима.',
      ur: 'Staking آپ کے AiG Token کو ایک مدت کے لیے لاک کرتا ہے اور ہولڈنگ کے دوران AiG میں فائدہ پیدا کرتا ہے۔ اقدامات: 1) اپنے اکاؤنٹ میں Staking پر جائیں۔ 2) مدت چنیں: جتنی لمبی، ماہانہ شرح اتنی زیادہ — 1 ماہ 6٪، 3 ماہ 8٪، 6 ماہ 10٪، 9 ماہ 12٪، 12 ماہ 15٪۔ 3) اپنے والٹ سے لاک کی تصدیق کریں۔ 4) مدت کے دوران AiG Token میں پیدا ہونے والا فائدہ آپ کو ملتا ہے۔ یہ ان کے لیے حکمتِ عملی ہے جو طویل مدت میں جمع کرتے ہیں۔ یہ شرحیں پروٹوکول کے اجرا کی ہیں، ڈالر میں یقینی نتیجہ نہیں۔',
    },
  '¿Cómo reclamo mis recompensas? Paso a paso': {
    en: 'How do I claim my rewards? Step by step',
    pt: 'Como resgato minhas recompensas? Passo a passo',
    fr: 'Comment réclamer mes récompenses ? Étape par étape',
    ru: 'Как забрать мои награды? Шаг за шагом',
    sv: 'Hur hämtar jag mina belöningar? Steg för steg',
    hr: 'Kako preuzimam svoje nagrade? Korak po korak',
    ar: 'كيف أطالب بمكافآتي؟ خطوة بخطوة',
    de: 'Wie fordere ich meine Belohnungen an? Schritt für Schritt',
    sr: 'Како преузимам своје награде? Корак по корак',
    ur: 'میں اپنے انعامات کیسے وصول کروں؟ قدم بہ قدم',
  },
  'Las recompensas de minería y booster se acumulan a diario en AiG Token; reclamar las lleva a tu balance disponible. Pasos: 1) En tu cuenta, en la sección de recompensas, pulsa Reclamar. 2) Para pasar de USDT a AiG puedes reclamar desde 10 USDT acumulados en adelante. 3) Confirma. 4) El reclamo puede tardar de 1 minuto a hasta 72 horas en llegar a tu wallet, según los procesos de verificación y seguridad — si estás en ese plazo, está en curso; abrir otro reclamo no lo acelera. Guarda el detalle de la operación por si necesitas soporte.':
    {
      en: 'Mining and booster rewards accumulate daily in AiG Token; claiming moves them to your available balance. Steps: 1) In your account, in the rewards section, press Claim. 2) To go from USDT to AiG you can claim from 10 accumulated USDT upward. 3) Confirm. 4) The claim can take from 1 minute up to 72 hours to reach your wallet, depending on the verification and security processes — if you are within that window, it is in progress; opening another claim does not speed it up. Keep the details of the operation in case you need support.',
      pt: 'As recompensas de mineração e booster se acumulam diariamente em AiG Token; resgatar as leva ao seu saldo disponível. Passos: 1) Na sua conta, na seção de recompensas, aperte Resgatar. 2) Para passar de USDT a AiG você pode resgatar a partir de 10 USDT acumulados. 3) Confirme. 4) O resgate pode levar de 1 minuto a até 72 horas para chegar à sua wallet, conforme os processos de verificação e segurança — se você está nesse prazo, está em curso; abrir outro resgate não acelera. Guarde o detalhe da operação caso precise de suporte.',
      fr: 'Les récompenses de minage et de booster s’accumulent chaque jour en AiG Token ; les réclamer les transfère vers ton solde disponible. Étapes : 1) Dans ton compte, à la section récompenses, appuie sur Réclamer. 2) Pour passer d’USDT à AiG, tu peux réclamer à partir de 10 USDT accumulés. 3) Confirme. 4) La réclamation peut mettre de 1 minute à 72 heures pour arriver dans ta wallet, selon les processus de vérification et de sécurité — si tu es dans ce délai, c’est en cours ; ouvrir une autre réclamation ne l’accélère pas. Conserve le détail de l’opération au cas où tu aurais besoin du support.',
      ru: 'Награды за майнинг и booster копятся ежедневно в AiG Token; получение переводит их на твой доступный баланс. Шаги: 1) В аккаунте, в разделе наград, нажми «Получить». 2) Чтобы перейти из USDT в AiG, можно получать от 10 накопленных USDT и выше. 3) Подтверди. 4) Заявка может идти до кошелька от 1 минуты до 72 часов, в зависимости от проверок и процедур безопасности — если ты в этом сроке, она в работе; ещё одна заявка её не ускорит. Сохрани детали операции на случай обращения в поддержку.',
      sv: 'Belöningar från mining och booster ackumuleras dagligen i AiG Token; att hämta dem flyttar dem till ditt tillgängliga saldo. Steg: 1) Tryck på Hämta i belöningsavsnittet på ditt konto. 2) För att gå från USDT till AiG kan du hämta från 10 ackumulerade USDT och uppåt. 3) Bekräfta. 4) Uttaget kan ta från 1 minut upp till 72 timmar att nå din plånbok, beroende på verifierings- och säkerhetsprocesserna — om du är inom den tiden pågår det; att öppna en till begäran snabbar inte på det. Spara detaljerna om transaktionen ifall du behöver support.',
      hr: 'Nagrade od rudarenja i boostera dnevno se gomilaju u AiG Tokenu; preuzimanje ih prebacuje na tvoj raspoloživi saldo. Koraci: 1) U svom računu, u odjeljku nagrada, pritisni Preuzmi. 2) Za prijelaz iz USDT-a u AiG možeš preuzimati od 10 nagomilanih USDT-a naviše. 3) Potvrdi. 4) Preuzimanje može trajati od 1 minute do 72 sata dok ne stigne u tvoj novčanik, ovisno o procesima provjere i sigurnosti — ako si u tom roku, u tijeku je; otvaranje još jednog zahtjeva ga ne ubrzava. Sačuvaj detalje operacije za slučaj da ti zatreba podrška.',
      ar: 'تتراكم مكافآت التعدين والـ booster يوميًا بالـ AiG Token؛ والمطالبة تنقلها إلى رصيدك المتاح. الخطوات: 1) في حسابك، في قسم المكافآت، اضغط «مطالبة». 2) للانتقال من USDT إلى AiG يمكنك المطالبة ابتداءً من 10 USDT متراكمة فصاعدًا. 3) أكّد. 4) قد تستغرق المطالبة من دقيقة واحدة إلى 72 ساعة حتى تصل إلى محفظتك، بحسب إجراءات التحقق والأمان — إن كنت ضمن هذه المهلة فهي قيد التنفيذ؛ وفتح مطالبة أخرى لا يُسرّعها. احفظ تفاصيل العملية تحسّبًا لحاجتك إلى الدعم.',
      de: 'Mining- und Booster-Belohnungen sammeln sich täglich in AiG Token; das Anfordern bringt sie auf dein verfügbares Guthaben. Schritte: 1) Drück in deinem Konto im Bereich Belohnungen auf Anfordern. 2) Um von USDT auf AiG zu wechseln, kannst du ab 10 angesammelten USDT anfordern. 3) Bestätige. 4) Die Anforderung kann zwischen 1 Minute und bis zu 72 Stunden brauchen, bis sie in deiner Wallet ankommt — je nach Prüf- und Sicherheitsprozessen. Bist du in dieser Frist, läuft sie; eine weitere Anforderung beschleunigt nichts. Sichere die Details des Vorgangs, falls du den Support brauchst.',
      sr: 'Награде од рударења и boostera дневно се гомилају у AiG Token-у; преузимање их пребацује на твој расположиви салдо. Кораци: 1) У свом налогу, у одељку награда, притисни Преузми. 2) За прелазак из USDT-а у AiG можеш преузимати од 10 нагомиланих USDT-а навише. 3) Потврди. 4) Преузимање може трајати од 1 минута до 72 сата док не стигне у твој новчаник, у зависности од процеса провере и безбедности — ако си у том року, у току је; отварање још једног захтева га не убрзава. Сачувај детаље операције за случај да ти затреба подршка.',
      ur: 'مائننگ اور booster کے انعامات روزانہ AiG Token میں جمع ہوتے ہیں؛ وصول کرنے پر وہ آپ کے دستیاب بیلنس میں چلے جاتے ہیں۔ اقدامات: 1) اپنے اکاؤنٹ کے انعامات والے حصے میں «وصول کریں» دبائیں۔ 2) USDT سے AiG میں جانے کے لیے آپ 10 جمع شدہ USDT سے وصول کر سکتے ہیں۔ 3) تصدیق کریں۔ 4) تصدیق اور سیکیورٹی کے مراحل کے مطابق درخواست کو آپ کے والٹ تک پہنچنے میں 1 منٹ سے 72 گھنٹے تک لگ سکتے ہیں — اگر آپ اس مدت میں ہیں تو یہ جاری ہے؛ ایک اور درخواست کھولنے سے یہ تیز نہیں ہوتی۔ مدد کی ضرورت پڑنے کی صورت میں کارروائی کی تفصیل محفوظ رکھیں۔',
    },
  '¿Con qué monedas pago la membresía de G-Pulse?': {
    en: 'Which currencies do I pay the G-Pulse membership with?',
    pt: 'Com quais moedas pago a assinatura do G-Pulse?',
    fr: 'Avec quelles monnaies puis-je payer l’abonnement G-Pulse ?',
    ru: 'Какими валютами оплачивается членство G-Pulse?',
    sv: 'Med vilka valutor betalar jag G-Pulse-medlemskapet?',
    hr: 'Kojim valutama plaćam članstvo u G-Pulseu?',
    ar: 'بأي عملات أدفع اشتراك G-Pulse؟',
    de: 'Mit welchen Währungen zahle ich die G-Pulse-Mitgliedschaft?',
    sr: 'Којим валутама плаћам чланство у G-Pulse-у?',
    ur: 'میں G-Pulse کی رکنیت کن کرنسیوں سے ادا کروں؟',
  },
  'El pago de la membresía es DUAL 50/50: se cubre mitad en USDT y mitad en AiG Token, y ambas partes viajan juntas en una sola transacción desde tu wallet (necesitas saldo de USDT y de AiG en la red BSC, más BNB para el gas). No es solo-USDT ni solo-AiG: el modo de activación de G-Pulse es el dual. Si la transacción no se refleja, no la repitas: guarda el hash y repórtalo.':
    {
      en: 'The membership payment is DUAL 50/50: half is covered in USDT and half in AiG Token, and both parts travel together in a single transaction from your wallet (you need a USDT and an AiG balance on the BSC network, plus BNB for gas). It is not USDT-only or AiG-only: G-Pulse’s activation mode is the dual one. If the transaction is not reflected, do not repeat it: save the hash and report it.',
      pt: 'O pagamento da assinatura é DUAL 50/50: cobre-se metade em USDT e metade em AiG Token, e ambas as partes viajam juntas em uma única transação a partir da sua wallet (precisa de saldo de USDT e de AiG na rede BSC, mais BNB para o gas). Não é só-USDT nem só-AiG: o modo de ativação do G-Pulse é o dual. Se a transação não se refletir, não a repita: guarde o hash e reporte.',
      fr: 'Le paiement de l’abonnement est DUAL 50/50 : la moitié en USDT et la moitié en AiG Token, et les deux parties voyagent ensemble dans une seule transaction depuis ta wallet (il te faut un solde d’USDT et d’AiG sur le réseau BSC, plus du BNB pour le gas). Ce n’est pas uniquement USDT ni uniquement AiG : le mode d’activation de G-Pulse est le dual. Si la transaction n’apparaît pas, ne la refais pas : garde le hash et signale-le.',
      ru: 'Оплата членства — ДВОЙНАЯ 50/50: половина в USDT и половина в AiG Token, и обе части идут вместе одной транзакцией из твоего кошелька (нужен баланс USDT и AiG в сети BSC плюс BNB на газ). Это не «только USDT» и не «только AiG»: режим активации G-Pulse — двойной. Если транзакция не отражается, не повторяй её: сохрани хеш и сообщи о ней.',
      sv: 'Betalningen av medlemskapet är DUAL 50/50: hälften täcks i USDT och hälften i AiG Token, och båda delarna färdas tillsammans i en enda transaktion från din plånbok (du behöver saldo i USDT och AiG på BSC-nätverket, plus BNB till gas). Det är inte enbart USDT eller enbart AiG: G-Pulses aktiveringsläge är det duala. Om transaktionen inte syns — upprepa den inte: spara hashen och anmäl den.',
      hr: 'Plaćanje članstva je DUALNO 50/50: pola se pokriva u USDT-u i pola u AiG Tokenu, a oba dijela putuju zajedno u jednoj transakciji iz tvog novčanika (trebaš stanje USDT-a i AiG-a na mreži BSC, plus BNB za gas). Nije samo-USDT ni samo-AiG: način aktivacije G-Pulsea je dualni. Ako se transakcija ne vidi, nemoj je ponavljati: spremi hash i prijavi ga.',
      ar: 'دفع الاشتراك ثنائي 50/50: يُغطّى نصفه بالـ USDT ونصفه بالـ AiG Token، ويسافر الجزآن معًا في معاملة واحدة من محفظتك (تحتاج رصيدًا من USDT ومن AiG على شبكة BSC، إضافةً إلى BNB للغاز). ليس بالـ USDT وحده ولا بالـ AiG وحده: وضع تفعيل G-Pulse هو الثنائي. إن لم تظهر المعاملة فلا تكرّرها: احفظ الهاش وأبلغ عنه.',
      de: 'Die Zahlung der Mitgliedschaft ist DUAL 50/50: Die Hälfte wird in USDT und die Hälfte in AiG Token gedeckt, und beide Teile reisen gemeinsam in einer einzigen Transaktion aus deiner Wallet (du brauchst USDT- und AiG-Guthaben im BSC-Netzwerk sowie BNB für das Gas). Es ist weder nur-USDT noch nur-AiG: Der Aktivierungsmodus von G-Pulse ist der duale. Wenn die Transaktion nicht erscheint, wiederhole sie nicht: Sichere den Hash und melde ihn.',
      sr: 'Плаћање чланства је ДУАЛНО 50/50: пола се покрива у USDT-у и пола у AiG Token-у, а оба дела путују заједно у једној трансакцији из твог новчаника (треба ти стање USDT-а и AiG-а на мрежи BSC, плус BNB за гас). Није само-USDT ни само-AiG: начин активације G-Pulse-а је дуални. Ако се трансакција не види, немој је понављати: сачувај хеш и пријави га.',
      ur: 'رکنیت کی ادائیگی DUAL 50/50 ہے: آدھی USDT میں اور آدھی AiG Token میں، اور دونوں حصے آپ کے والٹ سے ایک ہی ٹرانزیکشن میں ساتھ جاتے ہیں (آپ کو BSC نیٹ ورک پر USDT اور AiG کا بیلنس چاہیے، اور گیس کے لیے BNB)۔ یہ صرف-USDT یا صرف-AiG نہیں: G-Pulse کے فعال کرنے کا طریقہ dual ہے۔ اگر ٹرانزیکشن ظاہر نہ ہو تو اسے نہ دہرائیں: ہیش محفوظ کریں اور اطلاع دیں۔',
    },
  '¿Qué modos tiene G-Pulse: manual y automático?': {
    en: 'What modes does G-Pulse have: manual and automatic?',
    pt: 'Que modos o G-Pulse tem: manual e automático?',
    fr: 'Quels modes a G-Pulse : manuel et automatique ?',
    ru: 'Какие режимы есть у G-Pulse: ручной и автоматический?',
    sv: 'Vilka lägen har G-Pulse: manuellt och automatiskt?',
    hr: 'Koje načine rada ima G-Pulse: ručni i automatski?',
    ar: 'ما أوضاع G-Pulse: يدوي وتلقائي؟',
    de: 'Welche Modi hat G-Pulse: manuell und automatisch?',
    sr: 'Које начине рада има G-Pulse: ручни и аутоматски?',
    ur: 'G-Pulse کے کون سے موڈ ہیں: دستی اور خودکار؟',
  },
  'G-Pulse tiene dos modos de trabajo. El modo MANUAL: la herramienta te muestra las señales y las decisiones las tomas y ejecutas tú, a tu criterio. El modo AUTOMÁTICO (auto IA): un bot ejecuta la estrategia que tú configuras, sin que tengas que estar delante. Ambos parten de la misma base: G-Pulse informa y ejecuta lo que tú defines; no es asesoramiento financiero, no adivina el futuro y el resultado y el riesgo son tuyos. El bot automático básico entra desde BASIC; el avanzado y el Oracle Runtime, desde PRO en adelante.':
    {
      en: 'G-Pulse has two working modes. MANUAL mode: the tool shows you the signals, and you make and execute the decisions, at your own judgment. AUTOMATIC mode (auto AI): a bot executes the strategy you configure, without you having to be there. Both start from the same base: G-Pulse informs and executes what you define; it is not financial advice, it does not predict the future, and the outcome and the risk are yours. The basic automatic bot comes in from BASIC; the advanced one and the Oracle Runtime, from PRO upward.',
      pt: 'O G-Pulse tem dois modos de trabalho. O modo MANUAL: a ferramenta te mostra os sinais e as decisões você toma e executa, a seu critério. O modo AUTOMÁTICO (auto IA): um bot executa a estratégia que você configura, sem que precise estar na frente. Ambos partem da mesma base: o G-Pulse informa e executa o que você define; não é assessoria financeira, não adivinha o futuro e o resultado e o risco são seus. O bot automático básico entra a partir do BASIC; o avançado e o Oracle Runtime, do PRO em diante.',
      fr: 'G-Pulse a deux modes de travail. Le mode MANUEL : l’outil t’affiche les signaux et c’est toi qui prends et exécutes les décisions, à ton jugement. Le mode AUTOMATIQUE (auto IA) : un bot exécute la stratégie que tu configures, sans que tu aies à être devant. Les deux partent de la même base : G-Pulse informe et exécute ce que tu définis ; ce n’est pas un conseil financier, il ne devine pas l’avenir, et le résultat comme le risque sont les tiens. Le bot automatique de base entre dès BASIC ; l’avancé et l’Oracle Runtime, à partir de PRO.',
      ru: 'У G-Pulse два режима работы. РУЧНОЙ режим: инструмент показывает тебе сигналы, а решения принимаешь и исполняешь ты, на своё усмотрение. АВТОМАТИЧЕСКИЙ режим (авто-ИИ): бот исполняет стратегию, которую ты настраиваешь, без твоего присутствия. Оба исходят из одного и того же: G-Pulse информирует и исполняет то, что ты определил; это не финансовая консультация, он не угадывает будущее, а результат и риск — твои. Базовый автоматический бот доступен с BASIC; продвинутый и Oracle Runtime — с PRO и выше.',
      sv: 'G-Pulse har två arbetslägen. MANUELLT läge: verktyget visar dig signalerna och besluten fattar och utför du, efter eget omdöme. AUTOMATISKT läge (auto-AI): en bot utför den strategi du konfigurerar, utan att du behöver sitta framför. Båda utgår från samma grund: G-Pulse informerar och utför det du definierar; det är inte finansiell rådgivning, det spår inte framtiden, och resultatet och risken är dina. Den grundläggande automatiska boten ingår från BASIC; den avancerade och Oracle Runtime från PRO och uppåt.',
      hr: 'G-Pulse ima dva načina rada. RUČNI način: alat ti pokazuje signale, a odluke donosiš i izvršavaš ti, po vlastitoj prosudbi. AUTOMATSKI način (auto UI): bot izvršava strategiju koju ti podesiš, bez da moraš biti prisutan. Oba polaze od iste osnove: G-Pulse informira i izvršava ono što ti odrediš; nije financijski savjet, ne pogađa budućnost, a rezultat i rizik su tvoji. Osnovni automatski bot ulazi od BASIC-a; napredni i Oracle Runtime, od PRO-a naviše.',
      ar: 'لدى G-Pulse وضعان للعمل. الوضع اليدوي: تعرض عليك الأداة الإشارات، وأنت من يتخذ القرارات وينفّذها وفق تقديرك. الوضع التلقائي (ذكاء اصطناعي آلي): ينفّذ روبوت الاستراتيجية التي تضبطها أنت، دون حاجة لوجودك. كلاهما ينطلق من الأساس نفسه: G-Pulse يُعلم وينفّذ ما تحدّده أنت؛ ليس نصيحة مالية، ولا يتنبأ بالمستقبل، والنتيجة والمخاطرة لك. الروبوت التلقائي الأساسي متاح من BASIC؛ والمتقدّم و Oracle Runtime من PRO فما فوق.',
      de: 'G-Pulse hat zwei Arbeitsmodi. MANUELLER Modus: Das Werkzeug zeigt dir die Signale, und die Entscheidungen triffst und führst du aus, nach eigenem Ermessen. AUTOMATISCHER Modus (Auto-KI): Ein Bot führt die Strategie aus, die du konfigurierst, ohne dass du davorsitzen musst. Beide gehen von derselben Grundlage aus: G-Pulse informiert und führt aus, was du festlegst; es ist keine Finanzberatung, es errät die Zukunft nicht, und Ergebnis wie Risiko liegen bei dir. Der einfache Auto-Bot ist ab BASIC dabei; der fortgeschrittene und die Oracle Runtime ab PRO aufwärts.',
      sr: 'G-Pulse има два начина рада. РУЧНИ начин: алат ти приказује сигнале, а одлуке доносиш и извршаваш ти, по сопственој процени. АУТОМАТСКИ начин (ауто ВИ): бот извршава стратегију коју ти подесиш, без да мораш бити присутан. Оба полазе од исте основе: G-Pulse информише и извршава оно што ти одредиш; није финансијски савет, не погађа будућност, а резултат и ризик су твоји. Основни аутоматски бот улази од BASIC-а; напредни и Oracle Runtime, од PRO-а навише.',
      ur: 'G-Pulse کے کام کے دو موڈ ہیں۔ دستی موڈ: ٹول آپ کو سگنلز دکھاتا ہے اور فیصلے آپ اپنی صوابدید سے کرتے اور نافذ کرتے ہیں۔ خودکار موڈ (auto AI): ایک بوٹ وہ حکمتِ عملی چلاتا ہے جو آپ ترتیب دیتے ہیں، بغیر اس کے کہ آپ سامنے موجود ہوں۔ دونوں کی بنیاد ایک ہی ہے: G-Pulse آپ کو بتاتا ہے اور وہی کرتا ہے جو آپ طے کرتے ہیں؛ یہ مالی مشورہ نہیں، مستقبل کا اندازہ نہیں لگاتا، اور نتیجہ اور خطرہ آپ کا ہے۔ بنیادی خودکار بوٹ BASIC سے شامل ہے؛ ایڈوانسڈ اور Oracle Runtime، PRO سے آگے۔',
    },
  '¿Cómo configuro una jugada y cómo la detengo?': {
    en: 'How do I set up a play and how do I stop it?',
    pt: 'Como configuro uma jogada e como a paro?',
    fr: 'Comment configurer une opération et comment l’arrêter ?',
    ru: 'Как настроить сделку и как её остановить?',
    sv: 'Hur ställer jag in ett drag och hur stoppar jag det?',
    hr: 'Kako podešavam potez i kako ga zaustavljam?',
    ar: 'كيف أضبط عملية وكيف أوقفها؟',
    de: 'Wie richte ich einen Zug ein und wie stoppe ich ihn?',
    sr: 'Како подешавам потез и како га заустављам?',
    ur: 'میں کوئی چال کیسے سیٹ کروں اور کیسے روکوں؟',
  },
  'El recorrido exacto (configurar los parámetros, iniciar y detener) está dentro del panel, detrás del acceso, y esta guía no describe pantallas que no se han recorrido: antes que darte una ruta inventada, se te pasa con alguien que lo tenga delante. Lo que sí es firme: necesitas la membresía vigente, el modo automático ejecuta la estrategia que TÚ configuras y puedes detenerlo desde el mismo panel. Tú decides los parámetros y asumes el resultado; G-Pulse no garantiza ninguna ganancia.':
    {
      en: 'The exact path (setting the parameters, starting and stopping) is inside the panel, behind the login, and this guide does not describe screens that have not been walked through: rather than give you an invented route, you get passed to someone who has it in front of them. What is firm: you need an active membership, the automatic mode executes the strategy YOU configure, and you can stop it from that same panel. You decide the parameters and you take on the outcome; G-Pulse guarantees no profit.',
      pt: 'O percurso exato (configurar os parâmetros, iniciar e parar) está dentro do painel, atrás do acesso, e este guia não descreve telas que não foram percorridas: antes de te dar uma rota inventada, te passamos com alguém que a tenha na frente. O que é firme: precisa da assinatura vigente, o modo automático executa a estratégia que VOCÊ configura e pode pará-lo pelo mesmo painel. Você decide os parâmetros e assume o resultado; o G-Pulse não garante nenhum ganho.',
      fr: 'Le parcours exact (configurer les paramètres, lancer et arrêter) se trouve dans le panneau, derrière l’accès, et ce guide ne décrit pas des écrans qui n’ont pas été parcourus : plutôt que de t’inventer un chemin, on te passe quelqu’un qui l’a sous les yeux. Ce qui est ferme : il te faut l’abonnement en cours, le mode automatique exécute la stratégie que TOI tu configures, et tu peux l’arrêter depuis ce même panneau. Tu décides les paramètres et tu assumes le résultat ; G-Pulse ne garantit aucun gain.',
      ru: 'Точный путь (настроить параметры, запустить и остановить) находится внутри панели, за входом, и это руководство не описывает экраны, по которым никто не прошёл: вместо выдуманного маршрута тебя передадут тому, у кого он перед глазами. Что твёрдо: нужно действующее членство, автоматический режим исполняет стратегию, которую настраиваешь ТЫ, и остановить его можно из той же панели. Параметры решаешь ты и результат принимаешь ты; G-Pulse не гарантирует никакой прибыли.',
      sv: 'Den exakta vägen (ställa in parametrarna, starta och stoppa) finns inne i panelen, bakom inloggningen, och den här guiden beskriver inte skärmar som ingen gått igenom: hellre än att hitta på en väg åt dig kopplas du till någon som har den framför sig. Det som står fast: du behöver ett giltigt medlemskap, det automatiska läget kör den strategi DU ställer in, och du kan stoppa det från samma panel. Du bestämmer parametrarna och tar resultatet; G-Pulse garanterar ingen vinst.',
      hr: 'Točan put (podešavanje parametara, pokretanje i zaustavljanje) je unutar panela, iza prijave, a ovaj vodič ne opisuje zaslone kojima nitko nije prošao: prije nego da ti damo izmišljenu rutu, spajamo te s nekim tko je ima pred sobom. Ono što je čvrsto: treba ti važeće članstvo, automatski način izvršava strategiju koju TI podesiš i možeš ga zaustaviti s istog panela. Ti odlučuješ o parametrima i preuzimaš rezultat; G-Pulse ne jamči nikakvu dobit.',
      ar: 'المسار الدقيق (ضبط المعطيات والبدء والإيقاف) داخل اللوحة خلف تسجيل الدخول، وهذا الدليل لا يصف شاشات لم يجرِ المرور بها: بدل أن نعطيك طريقًا مُختلقًا، نحوّلك إلى شخص يراها أمامه. أما الثابت فهو: تحتاج اشتراكًا ساريًا، والوضع التلقائي ينفّذ الاستراتيجية التي تضبطها أنت، ويمكنك إيقافه من اللوحة نفسها. أنت تقرّر المعطيات وتتحمّل النتيجة؛ G-Pulse لا يضمن أي ربح.',
      de: 'Der genaue Weg (Parameter einstellen, starten und stoppen) liegt im Panel hinter dem Login, und dieser Leitfaden beschreibt keine Bildschirme, die niemand durchlaufen hat: Statt dir eine erfundene Route zu geben, wirst du an jemanden weitergereicht, der sie vor sich hat. Fest steht: Du brauchst eine gültige Mitgliedschaft, der automatische Modus führt die Strategie aus, die DU konfigurierst, und du kannst ihn aus demselben Panel stoppen. Du entscheidest über die Parameter und trägst das Ergebnis; G-Pulse garantiert keinerlei Gewinn.',
      sr: 'Тачан пут (подешавање параметара, покретање и заустављање) је унутар панела, иза пријаве, а овај водич не описује екране којима нико није прошао: пре него да ти дамо измишљену руту, спајамо те с неким ко је има пред собом. Оно што је чврсто: треба ти важеће чланство, аутоматски начин извршава стратегију коју ТИ подесиш и можеш га зауставити са истог панела. Ти одлучујеш о параметрима и преузимаш резултат; G-Pulse не гарантује никакву добит.',
      ur: 'صحیح راستہ (پیرامیٹر سیٹ کرنا، شروع اور بند کرنا) پینل کے اندر، لاگ اِن کے پیچھے ہے، اور یہ رہنما ان اسکرینوں کو بیان نہیں کرتی جن سے کوئی گزرا نہیں: آپ کو گھڑا ہوا راستہ دینے کے بجائے، آپ کو اُس شخص سے ملایا جاتا ہے جس کے سامنے وہ موجود ہے۔ جو بات پکی ہے: آپ کو مؤثر رکنیت چاہیے، خودکار موڈ وہی حکمتِ عملی چلاتا ہے جو آپ سیٹ کرتے ہیں، اور آپ اسے اسی پینل سے روک سکتے ہیں۔ پیرامیٹر آپ طے کرتے ہیں اور نتیجہ آپ کا؛ G-Pulse کسی منافع کی ضمانت نہیں دیتا۔',
    },

  /* ══════════════════════════════════════════════════════════════════
     CORPUS · GENESIS, G11, SEGURIDAD Y EL CONTRATO (cierre del corpus)

     LA RESPUESTA DEL CONTRATO ES LA ÚNICA CUYA CLAVE NO SE ESCRIBIÓ A MANO: en
     `preguntas-token.ts` es una plantilla que interpola `AIG_TOKEN_CONTRACT`
     desde la fuente única, y aquí está su resultado ya renderizado.
     Consecuencia deliberada: si algún día el contrato migra otra vez, la clave
     deja de coincidir y la respuesta cae al español — con la dirección NUEVA,
     porque el español también se deriva. Se pierde el idioma, nunca se sirve
     una dirección vieja traducida. De los dos fallos posibles, éste es el único
     que no le cuesta dinero a nadie.

     «NADIE DEL EQUIPO TE VA A PEDIR TU FRASE DE RECUPERACIÓN» es la frase que
     más veces evita una pérdida total, y va completa y en el mismo lugar de la
  ...
  '¿Cuál es el contrato oficial del AiG Token?': {
    ...
    fr: 'Quel est le contrat officiel du AiG Token ?',
    ru: 'Какой официальный контракт у AiG Token?',
    sv: 'Vilket är AiG Tokens officiella kontrakt?',
    hr: 'Koji je službeni ugovor AiG Tokena?',
    ar: 'ما هو العقد الرسمي لـ AiG Token؟',
    de: 'Was ist der offizielle Vertrag des AiG Token?',
    sr: 'Који је званични уговор AiG Token-а?',
    ur: 'AiG Token کا سرکاری کنٹریکٹ کون سا ہے؟',
  },
  'El contrato oficial en BSC es 0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Puedes verificarlo en BscScan: bscscan.com/token/0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Desconfía de cualquier otra dirección — un contrato distinto NO es el AiG oficial, aunque se llame parecido y aunque tenga el mismo símbolo.':
    {
      en: 'The official contract on BSC is 0xC1F0768587Dc889e494C171B155C60B4e9a13F08. You can verify it on BscScan: bscscan.com/token/0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Distrust any other address — a different contract is NOT the official AiG, even if it is named similarly and even if it has the same symbol.',
      pt: 'O contrato oficial na BSC é 0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Você pode verificá-lo no BscScan: bscscan.com/token/0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Desconfie de qualquer outro endereço — um contrato diferente NÃO é o AiG oficial, mesmo que tenha nome parecido e mesmo que tenha o mesmo símbolo.',
      fr: 'Le contrat officiel sur BSC est 0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Tu peux le vérifier sur BscScan : bscscan.com/token/0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Méfie-toi de toute autre adresse — un contrat différent N’EST PAS le AiG officiel, même s’il porte un nom semblable et même s’il a le même symbole.',
      ru: 'Официальный контракт в BSC — 0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Проверить его можно на BscScan: bscscan.com/token/0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Не доверяй никакому другому адресу — другой контракт НЕ является официальным AiG, даже если он называется похоже и даже если у него тот же символ.',
      sv: 'Det officiella kontraktet på BSC är 0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Du kan verifiera det på BscScan: bscscan.com/token/0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Misstro varje annan adress — ett annat kontrakt är INTE det officiella AiG, även om det heter något liknande och även om det har samma symbol.',
      hr: 'Službeni ugovor na BSC-u je 0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Možeš ga provjeriti na BscScanu: bscscan.com/token/0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Ne vjeruj nijednoj drugoj adresi — drugačiji ugovor NIJE službeni AiG, čak i ako se zove slično i ako ima isti simbol.',
      ar: 'العقد الرسمي على BSC هو 0xC1F0768587Dc889e494C171B155C60B4e9a13F08. يمكنك التحقق منه على BscScan: bscscan.com/token/0xC1F0768587Dc889e494C171B155C60B4e9a13F08. لا تثق بأي عنوان آخر — فأي عقد مختلف ليس هو AiG الرسمي، ولو حمل اسمًا مشابهًا ولو كان له الرمز نفسه.',
      de: 'Der offizielle Vertrag auf BSC ist 0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Du kannst ihn auf BscScan prüfen: bscscan.com/token/0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Misstraue jeder anderen Adresse — ein anderer Vertrag ist NICHT der offizielle AiG, auch wenn er ähnlich heißt und auch wenn er dasselbe Symbol trägt.',
      sr: 'Званични уговор на BSC-у је 0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Можеш га проверити на BscScan-у: bscscan.com/token/0xC1F0768587Dc889e494C171B155C60B4e9a13F08. Не веруј ниједној другој адреси — другачији уговор НИЈЕ званични AiG, чак и ако се зове слично и ако има исти симбол.',
      ur: 'BSC پر سرکاری کنٹریکٹ 0xC1F0768587Dc889e494C171B155C60B4e9a13F08 ہے۔ آپ اسے BscScan پر جانچ سکتے ہیں: bscscan.com/token/0xC1F0768587Dc889e494C171B155C60B4e9a13F08۔ کسی بھی دوسرے پتے پر بھروسہ نہ کریں — کوئی مختلف کنٹریکٹ سرکاری AiG نہیں ہے، چاہے اس کا نام ملتا جلتا ہو اور چاہے اس کی علامت بھی وہی ہو۔',
    },
  '¿Qué es Genesis y cuál es su visión?': {
    en: 'What is Genesis and what is its vision?',
    pt: 'O que é a Genesis e qual é sua visão?',
    fr: 'Qu’est-ce que Genesis et quelle est sa vision ?',
    ru: 'Что такое Genesis и в чём его видение?',
    sv: 'Vad är Genesis och vad är dess vision?',
    hr: 'Što je Genesis i koja je njegova vizija?',
    ar: 'ما هي Genesis وما رؤيتها؟',
    de: 'Was ist Genesis und was ist seine Vision?',
    sr: 'Шта је Genesis и која је његова визија?',
    ur: 'Genesis کیا ہے اور اس کا وژن کیا ہے؟',
  },
  'Genesis es un ecosistema que une inteligencia artificial y blockchain para dar a su comunidad tecnología avanzada con transparencia y seguridad, apoyándose en contratos inteligentes públicos y en Web3 (donde tú controlas tus datos y decisiones). La IA es el cerebro que coordina los procesos; el blockchain aporta la transparencia. Alrededor del AiG Token, el ecosistema reúne varias piezas: minería (AiMining), staking, el plan de comunidad G11, la tienda, herramientas y proyectos anunciados en su hoja de ruta (academia, exchange, tarjeta, metaverso, NFTs). La idea de fondo: impulsar el desarrollo de la IA y el crecimiento de la comunidad con tecnología abierta y verificable.':
    {
      en: 'Genesis is an ecosystem that joins artificial intelligence and blockchain to give its community advanced technology with transparency and security, resting on public smart contracts and on Web3 (where you control your data and your decisions). The AI is the brain that coordinates the processes; the blockchain provides the transparency. Around the AiG Token, the ecosystem brings together several pieces: mining (AiMining), staking, the G11 community plan, the store, tools and projects announced on its roadmap (academy, exchange, card, metaverse, NFTs). The underlying idea: to drive AI development and the community’s growth with open, verifiable technology.',
      pt: 'A Genesis é um ecossistema que une inteligência artificial e blockchain para dar à sua comunidade tecnologia avançada com transparência e segurança, apoiando-se em contratos inteligentes públicos e na Web3 (onde você controla seus dados e decisões). A IA é o cérebro que coordena os processos; o blockchain traz a transparência. Em torno do AiG Token, o ecossistema reúne várias peças: mineração (AiMining), staking, o plano de comunidade G11, a loja, ferramentas e projetos anunciados no seu roadmap (academia, exchange, cartão, metaverso, NFTs). A ideia de fundo: impulsionar o desenvolvimento da IA e o crescimento da comunidade com tecnologia aberta e verificável.',
      fr: 'Genesis est un écosystème qui réunit intelligence artificielle et blockchain pour offrir à sa communauté une technologie avancée avec transparence et sécurité, en s’appuyant sur des contrats intelligents publics et sur le Web3 (où tu contrôles tes données et tes décisions). L’IA est le cerveau qui coordonne les processus ; la blockchain apporte la transparence. Autour du AiG Token, l’écosystème rassemble plusieurs pièces : le minage (AiMining), le staking, le plan communautaire G11, la boutique, des outils et des projets annoncés dans sa feuille de route (académie, exchange, carte, métavers, NFT). L’idée de fond : stimuler le développement de l’IA et la croissance de la communauté avec une technologie ouverte et vérifiable.',
      ru: 'Genesis — это экосистема, соединяющая искусственный интеллект и блокчейн, чтобы дать своему сообществу передовые технологии с прозрачностью и безопасностью, опираясь на публичные смарт-контракты и на Web3 (где ты сам управляешь своими данными и решениями). ИИ — это мозг, координирующий процессы; блокчейн даёт прозрачность. Вокруг AiG Token экосистема собирает несколько частей: майнинг (AiMining), стейкинг, общественный план G11, магазин, инструменты и проекты, заявленные в дорожной карте (академия, биржа, карта, метавселенная, NFT). Идея в основе: продвигать развитие ИИ и рост сообщества с помощью открытой и проверяемой технологии.',
      sv: 'Genesis är ett ekosystem som förenar artificiell intelligens och blockkedja för att ge sin gemenskap avancerad teknik med transparens och säkerhet, med stöd i publika smarta kontrakt och i Web3 (där du styr dina data och dina beslut). AI:n är hjärnan som samordnar processerna; blockkedjan bidrar med transparensen. Kring AiG Token samlar ekosystemet flera delar: mining (AiMining), staking, gemenskapsplanen G11, butiken, verktyg och projekt som annonserats i färdplanen (akademi, börs, kort, metaversum, NFT). Grundtanken: att driva AI-utvecklingen och gemenskapens tillväxt med öppen och verifierbar teknik.',
      hr: 'Genesis je ekosustav koji spaja umjetnu inteligenciju i blockchain kako bi svojoj zajednici dao naprednu tehnologiju uz transparentnost i sigurnost, oslanjajući se na javne pametne ugovore i na Web3 (gdje ti upravljaš svojim podacima i odlukama). Umjetna inteligencija je mozak koji usklađuje procese; blockchain donosi transparentnost. Oko AiG Tokena ekosustav okuplja nekoliko dijelova: rudarenje (AiMining), staking, plan zajednice G11, trgovinu, alate i projekte najavljene u mapi puta (akademija, burza, kartica, metaverzum, NFT-ovi). Temeljna ideja: potaknuti razvoj umjetne inteligencije i rast zajednice otvorenom i provjerljivom tehnologijom.',
      ar: 'Genesis نظام بيئي يجمع الذكاء الاصطناعي والبلوكتشين ليمنح مجتمعه تقنية متقدّمة بشفافية وأمان، مستندًا إلى عقود ذكية عامة وإلى Web3 (حيث تتحكّم أنت ببياناتك وقراراتك). الذكاء الاصطناعي هو الدماغ الذي ينسّق العمليات؛ والبلوكتشين يوفّر الشفافية. حول AiG Token يجمع النظام البيئي عدّة أجزاء: التعدين (AiMining)، والـ staking، وخطة المجتمع G11، والمتجر، وأدوات ومشاريع مُعلنة في خارطة الطريق (أكاديمية، منصّة تداول، بطاقة، ميتافيرس، NFTs). الفكرة الأساسية: دفع تطوير الذكاء الاصطناعي ونمو المجتمع بتقنية مفتوحة وقابلة للتحقّق.',
      de: 'Genesis ist ein Ökosystem, das künstliche Intelligenz und Blockchain verbindet, um seiner Community fortgeschrittene Technologie mit Transparenz und Sicherheit zu geben — gestützt auf öffentliche Smart Contracts und auf Web3 (wo du deine Daten und Entscheidungen kontrollierst). Die KI ist das Gehirn, das die Prozesse koordiniert; die Blockchain liefert die Transparenz. Rund um den AiG Token vereint das Ökosystem mehrere Teile: Mining (AiMining), Staking, den Community-Plan G11, den Shop, Werkzeuge und in der Roadmap angekündigte Projekte (Akademie, Exchange, Karte, Metaverse, NFTs). Der Grundgedanke: die Entwicklung der KI und das Wachstum der Community mit offener, überprüfbarer Technologie voranzutreiben.',
      sr: 'Genesis је екосистем који спаја вештачку интелигенцију и блокчејн како би својој заједници дао напредну технологију уз транспарентност и безбедност, ослањајући се на јавне паметне уговоре и на Web3 (где ти управљаш својим подацима и одлукама). Вештачка интелигенција је мозак који усклађује процесе; блокчејн доноси транспарентност. Око AiG Token-а екосистем окупља неколико делова: рударење (AiMining), staking, план заједнице G11, продавницу, алате и пројекте најављене у мапи пута (академија, берза, картица, метаверзум, NFT-ови). Основна идеја: подстаћи развој вештачке интелигенције и раст заједнице отвореном и проверљивом технологијом.',
      ur: 'Genesis ایک ایکو سسٹم ہے جو مصنوعی ذہانت اور بلاک چین کو جوڑ کر اپنی کمیونٹی کو شفافیت اور سیکیورٹی کے ساتھ جدید ٹیکنالوجی دیتا ہے، عوامی سمارٹ کنٹریکٹس اور Web3 پر قائم ہو کر (جہاں آپ اپنے ڈیٹا اور فیصلوں کے مالک ہیں)۔ AI وہ دماغ ہے جو عمل کو مربوط کرتا ہے؛ بلاک چین شفافیت دیتا ہے۔ AiG Token کے گرد ایکو سسٹم کئی حصے جمع کرتا ہے: مائننگ (AiMining)، staking، کمیونٹی پلان G11، اسٹور، ٹولز اور روڈ میپ میں اعلان کردہ منصوبے (اکیڈمی، ایکسچینج، کارڈ، میٹاورس، NFTs)۔ بنیادی خیال: کھلی اور قابلِ تصدیق ٹیکنالوجی سے AI کی ترقی اور کمیونٹی کی نمو کو آگے بڑھانا۔',
    },
  '¿Qué es el plan G11?': {
    en: 'What is the G11 plan?', pt: 'O que é o plano G11?', fr: 'Qu’est-ce que le plan G11 ?',
    ru: 'Что такое план G11?', sv: 'Vad är G11-planen?', hr: 'Što je plan G11?',
    ar: 'ما هي خطة G11؟', de: 'Was ist der G11-Plan?', sr: 'Шта је план G11?',
    ur: 'G11 پلان کیا ہے؟',
  },
  'G11 es el plan de comunidad de Genesis: el marco por el que la actividad en la red se reconoce con recompensas, de forma transparente gracias a la IA y el blockchain. Se apoya en cuatro piezas que ya tienen su paso a paso propio: tu pack de AiMining (el motor que genera AiG Token a diario), el acelerador por referido directo (AiG Start) y por equipos izquierdo/derecho (AiG Binary), el staking para quien acumula a largo plazo, y los rangos, que premian los hitos de tu red. G11 no es un producto que se compre aparte: se activa al participar en el ecosistema con tu pack de minería.':
    {
      en: 'G11 is Genesis’s community plan: the framework by which activity in the network is recognized with rewards, transparently thanks to AI and blockchain. It rests on four pieces that already have their own step by step: your AiMining pack (the engine that generates AiG Token daily), the accelerator by direct referral (AiG Start) and by left/right teams (AiG Binary), staking for those who accumulate long term, and the ranks, which reward your network’s milestones. G11 is not a product bought separately: it activates by taking part in the ecosystem with your mining pack.',
      pt: 'O G11 é o plano de comunidade da Genesis: o marco pelo qual a atividade na rede é reconhecida com recompensas, de forma transparente graças à IA e ao blockchain. Apoia-se em quatro peças que já têm seu passo a passo próprio: seu pack de AiMining (o motor que gera AiG Token diariamente), o acelerador por indicação direta (AiG Start) e por equipes esquerda/direita (AiG Binary), o staking para quem acumula a longo prazo, e os ranks, que premiam os marcos da sua rede. O G11 não é um produto que se compre à parte: ativa-se ao participar do ecossistema com seu pack de mineração.',
      fr: 'G11 est le plan communautaire de Genesis : le cadre par lequel l’activité sur le réseau est reconnue par des récompenses, de façon transparente grâce à l’IA et à la blockchain. Il repose sur quatre pièces qui ont déjà leur propre marche à suivre : ton pack AiMining (le moteur qui génère du AiG Token chaque jour), l’accélérateur par parrainage direct (AiG Start) et par équipes gauche/droite (AiG Binary), le staking pour qui accumule sur le long terme, et les rangs, qui récompensent les jalons de ton réseau. G11 n’est pas un produit qui s’achète à part : il s’active en participant à l’écosystème avec ton pack de minage.',
      ru: 'G11 — это общественный план Genesis: рамка, по которой активность в сети отмечается наградами, прозрачно, благодаря ИИ и блокчейну. Он опирается на четыре части, у каждой из которых уже есть свои шаги: твой пакет AiMining (двигатель, ежедневно генерирующий AiG Token), ускоритель по прямому рефералу (AiG Start) и по левой/правой командам (AiG Binary), стейкинг для тех, кто копит вдолгую, и ранги, которые вознаграждают вехи твоей сети. G11 — не продукт, покупаемый отдельно: он активируется участием в экосистеме с твоим майнинг-пакетом.',
      sv: 'G11 är Genesis gemenskapsplan: ramverket genom vilket aktivitet i nätverket erkänns med belöningar, transparent tack vare AI och blockkedja. Den vilar på fyra delar som redan har sina egna steg: ditt AiMining-paket (motorn som dagligen genererar AiG Token), acceleratorn via direkthänvisning (AiG Start) och via vänster/höger-team (AiG Binary), staking för den som samlar långsiktigt, och rangerna, som belönar ditt nätverks milstolpar. G11 är ingen produkt som köps separat: den aktiveras genom att delta i ekosystemet med ditt miningpaket.',
      hr: 'G11 je Genesisov plan zajednice: okvir kojim se aktivnost u mreži priznaje nagradama, transparentno zahvaljujući umjetnoj inteligenciji i blockchainu. Oslanja se na četiri dijela koji već imaju svoje korake: tvoj AiMining paket (motor koji dnevno stvara AiG Token), ubrzivač po izravnoj preporuci (AiG Start) i po lijevom/desnom timu (AiG Binary), staking za onoga tko gomila dugoročno, i rangove, koji nagrađuju prekretnice tvoje mreže. G11 nije proizvod koji se kupuje zasebno: aktivira se sudjelovanjem u ekosustavu s tvojim paketom rudarenja.',
      ar: 'G11 هي خطة المجتمع في Genesis: الإطار الذي يُعترف من خلاله بالنشاط في الشبكة عبر مكافآت، بشفافية بفضل الذكاء الاصطناعي والبلوكتشين. تقوم على أربع قطع لكلٍّ منها خطواتها الخاصة أصلًا: باقة AiMining لديك (المحرّك الذي يولّد AiG Token يوميًا)، ومسرّع الإحالة المباشرة (AiG Start) وفرق اليسار/اليمين (AiG Binary)، والـ staking لمن يراكم على المدى الطويل، والرتب التي تكافئ محطات شبكتك. G11 ليست منتجًا يُشترى على حدة: تُفعَّل بالمشاركة في النظام البيئي بباقة التعدين خاصتك.',
      de: 'G11 ist der Community-Plan von Genesis: der Rahmen, in dem Aktivität im Netzwerk mit Belohnungen anerkannt wird — transparent dank KI und Blockchain. Er stützt sich auf vier Teile, die jeweils schon ihre eigene Schritt-für-Schritt-Anleitung haben: dein AiMining-Paket (der Motor, der täglich AiG Token erzeugt), den Beschleuniger über Direktempfehlung (AiG Start) und über linkes/rechtes Team (AiG Binary), das Staking für alle, die langfristig ansammeln, und die Ränge, die die Meilensteine deines Netzwerks belohnen. G11 ist kein Produkt, das man separat kauft: Es aktiviert sich durch die Teilnahme am Ökosystem mit deinem Mining-Paket.',
      sr: 'G11 је Genesis-ов план заједнице: оквир којим се активност у мрежи признаје наградама, транспарентно захваљујући вештачкој интелигенцији и блокчејну. Ослања се на четири дела који већ имају своје кораке: твој AiMining пакет (мотор који дневно ствара AiG Token), убрзивач по директној препоруци (AiG Start) и по левом/десном тиму (AiG Binary), staking за онога ко гомила дугорочно, и рангове, који награђују прекретнице твоје мреже. G11 није производ који се купује засебно: активира се учешћем у екосистему са твојим пакетом рударења.',
      ur: 'G11 Genesis کا کمیونٹی پلان ہے: وہ ڈھانچہ جس کے ذریعے نیٹ ورک میں سرگرمی کو انعامات سے تسلیم کیا جاتا ہے، AI اور بلاک چین کی بدولت شفاف طریقے سے۔ یہ چار حصوں پر قائم ہے جن کے اپنے اقدامات پہلے سے موجود ہیں: آپ کا AiMining پیک (وہ انجن جو روزانہ AiG Token پیدا کرتا ہے)، ڈائریکٹ ریفرل (AiG Start) اور بائیں/دائیں ٹیم (AiG Binary) کا ایکسیلریٹر، طویل مدت میں جمع کرنے والوں کے لیے staking، اور رینکس، جو آپ کے نیٹ ورک کے سنگِ میل پر انعام دیتے ہیں۔ G11 الگ سے خریدی جانے والی مصنوعات نہیں: یہ اپنے مائننگ پیک کے ساتھ ایکو سسٹم میں شریک ہونے پر فعال ہوتا ہے۔',
    },
  /* La PREGUNTA de las fuentes verificables ya estaba traducida arriba, en el
     bloque de Seguridad; faltaba la respuesta con las dos reglas. */
  'Dos reglas que te protegen. Primera, lo verificable en cadena: el AiG Token y sus contratos inteligentes son públicos y se pueden consultar en BscScan (red BSC), y cada movimiento queda registrado — esa es la prueba real, no una captura de pantalla. Segunda, los canales: el sitio y la comunidad oficiales de Genesis son la única fuente de anuncios (fechas, promociones, novedades). Nadie del equipo te va a pedir tu frase de recuperación ni tus claves privadas: quien lo haga es una estafa. Si ves una fecha, un precio o una “oportunidad” fuera de los canales oficiales, trátalo con cautela y confírmalo antes de mover dinero.':
    {
      en: 'Two rules that protect you. First, what is verifiable on chain: the AiG Token and its smart contracts are public and can be checked on BscScan (BSC network), and every movement is recorded — that is the real proof, not a screenshot. Second, the channels: Genesis’s official site and community are the only source of announcements (dates, promotions, news). Nobody from the team will ask you for your recovery phrase or your private keys: anyone who does is a scam. If you see a date, a price or an “opportunity” outside the official channels, treat it with caution and confirm it before moving money.',
      pt: 'Duas regras que te protegem. Primeira, o verificável em cadeia: o AiG Token e seus contratos inteligentes são públicos e podem ser consultados no BscScan (rede BSC), e cada movimento fica registrado — essa é a prova real, não um print de tela. Segunda, os canais: o site e a comunidade oficiais da Genesis são a única fonte de anúncios (datas, promoções, novidades). Ninguém da equipe vai te pedir sua frase de recuperação nem suas chaves privadas: quem fizer isso é golpe. Se vir uma data, um preço ou uma “oportunidade” fora dos canais oficiais, trate com cautela e confirme antes de mover dinheiro.',
      fr: 'Deux règles qui te protègent. Première, ce qui est vérifiable sur la chaîne : le AiG Token et ses contrats intelligents sont publics et consultables sur BscScan (réseau BSC), et chaque mouvement est enregistré — c’est ça la vraie preuve, pas une capture d’écran. Deuxième, les canaux : le site et la communauté officiels de Genesis sont la seule source d’annonces (dates, promotions, nouveautés). Personne de l’équipe ne te demandera ta phrase de récupération ni tes clés privées : quiconque le fait est une arnaque. Si tu vois une date, un prix ou une « opportunité » hors des canaux officiels, traite-la avec prudence et confirme-la avant de bouger de l’argent.',
      ru: 'Два правила, которые тебя защищают. Первое — то, что проверяется в цепи: AiG Token и его смарт-контракты публичны, их можно посмотреть на BscScan (сеть BSC), и каждое движение записано — вот настоящее доказательство, а не скриншот. Второе — каналы: официальный сайт и сообщество Genesis — единственный источник объявлений (даты, акции, новости). Никто из команды не попросит у тебя сид-фразу или приватные ключи: тот, кто просит, — мошенник. Если ты видишь дату, цену или «возможность» вне официальных каналов, отнесись к этому осторожно и подтверди, прежде чем двигать деньги.',
      sv: 'Två regler som skyddar dig. För det första, det som går att verifiera på kedjan: AiG Token och dess smarta kontrakt är publika och kan kontrolleras på BscScan (BSC-nätverket), och varje rörelse registreras — det är det verkliga beviset, inte en skärmdump. För det andra, kanalerna: Genesis officiella webbplats och gemenskap är den enda källan till tillkännagivanden (datum, kampanjer, nyheter). Ingen i teamet kommer att be dig om din återställningsfras eller dina privata nycklar: den som gör det är en bedragare. Ser du ett datum, ett pris eller en ”möjlighet” utanför de officiella kanalerna — behandla det med försiktighet och bekräfta det innan du flyttar pengar.',
      hr: 'Dva pravila koja te štite. Prvo, ono što je provjerljivo na lancu: AiG Token i njegovi pametni ugovori su javni i mogu se pogledati na BscScanu (mreža BSC), a svaki je pokret zabilježen — to je pravi dokaz, a ne snimka zaslona. Drugo, kanali: službena stranica i zajednica Genesisa jedini su izvor objava (datumi, promocije, novosti). Nitko iz tima neće od tebe tražiti tvoju frazu za oporavak ni privatne ključeve: tko to učini, prevarant je. Ako vidiš datum, cijenu ili “priliku” izvan službenih kanala, uzmi to s oprezom i potvrdi prije nego pomakneš novac.',
      ar: 'قاعدتان تحميانك. الأولى، ما يمكن التحقّق منه على السلسلة: AiG Token وعقوده الذكية عامة ويمكن الاطّلاع عليها على BscScan (شبكة BSC)، وكل حركة مسجّلة — هذا هو الدليل الحقيقي، لا لقطة الشاشة. الثانية، القنوات: الموقع والمجتمع الرسميان لـ Genesis هما المصدر الوحيد للإعلانات (المواعيد، العروض، الأخبار). لن يطلب منك أحد من الفريق عبارة الاسترداد ولا مفاتيحك الخاصة: من يفعل ذلك محتال. إذا رأيت تاريخًا أو سعرًا أو «فرصة» خارج القنوات الرسمية، فتعامل معها بحذر وتحقّق منها قبل تحريك أي مال.',
      de: 'Zwei Regeln, die dich schützen. Erstens, das auf der Kette Überprüfbare: Der AiG Token und seine Smart Contracts sind öffentlich und lassen sich auf BscScan (BSC-Netzwerk) einsehen, und jede Bewegung wird aufgezeichnet — das ist der echte Beweis, kein Screenshot. Zweitens, die Kanäle: Die offizielle Seite und Community von Genesis sind die einzige Quelle für Ankündigungen (Termine, Aktionen, Neuigkeiten). Niemand aus dem Team wird dich nach deiner Wiederherstellungsphrase oder deinen privaten Schlüsseln fragen: Wer das tut, ist Betrug. Wenn du ein Datum, einen Preis oder eine „Gelegenheit“ außerhalb der offiziellen Kanäle siehst, behandle es mit Vorsicht und bestätige es, bevor du Geld bewegst.',
      sr: 'Два правила која те штите. Прво, оно што је проверљиво на ланцу: AiG Token и његови паметни уговори су јавни и могу се погледати на BscScan-у (мрежа BSC), а сваки покрет је забележен — то је прави доказ, а не снимак екрана. Друго, канали: званични сајт и заједница Genesis-а једини су извор објава (датуми, промоције, новости). Нико из тима неће од тебе тражити твоју фразу за опоравак ни приватне кључеве: ко то учини, преварант је. Ако видиш датум, цену или „прилику“ ван званичних канала, узми то са опрезом и потврди пре него што помериш новац.',
      ur: 'دو اصول جو آپ کی حفاظت کرتے ہیں۔ پہلا، وہ جو چین پر جانچا جا سکتا ہے: AiG Token اور اس کے سمارٹ کنٹریکٹس عوامی ہیں اور BscScan (BSC نیٹ ورک) پر دیکھے جا سکتے ہیں، اور ہر حرکت درج ہوتی ہے — یہی اصل ثبوت ہے، اسکرین شاٹ نہیں۔ دوسرا، چینلز: Genesis کی سرکاری سائٹ اور کمیونٹی ہی اعلانات (تاریخیں، پروموشنز، خبریں) کا واحد ذریعہ ہیں۔ ٹیم کا کوئی فرد آپ سے آپ کا ریکوری فقرہ یا نجی چابیاں نہیں مانگے گا: جو مانگے وہ فراڈ ہے۔ اگر آپ کو سرکاری چینلز سے باہر کوئی تاریخ، قیمت یا «موقع» نظر آئے تو اسے احتیاط سے لیں اور پیسہ ہلانے سے پہلے تصدیق کریں۔',
    },
