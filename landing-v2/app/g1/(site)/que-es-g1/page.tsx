...
const ENTIDADES = [
  {
    k: 'La comunidad',
    n: 'Génesis',
    d: 'La comunidad que se une y aporta usabilidad y liquidez al AiG Token a través de sus productos (G-Pulse, marketplace y más).',
  },
  {
    k: 'La tecnología',
    n: 'Aitech',
    d: 'Comunidad y compañía internacional que aporta la infraestructura y las herramientas de la alianza Aitech One.',
  },
  {
    k: 'El mercado',
    n: 'TAG',
    d: 'El acceso a los mercados con la trilogía: Tag Markets (trading), Bit1 (exchange) y BixCard (tarjeta Visa cripto).',
  },
]
...
export default function QueEsG1Page() {
  return (
    <div className="mx-auto max-w-6xl px-[clamp(16px,4vw,40px)]">
      ...
      {/* tres movimientos */}
      <section className="py-[clamp(32px,6vw,72px)]">
        <SectionReveal>
